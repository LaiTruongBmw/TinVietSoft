...
function OnReport()
{
		 var url = '/standard/reports/60/28/rpt_60280120_cash_daily_summary2.aspx?p_date='+dtDate.value+'&p_date_to='+dtDateTo.value+'&p_room='+txtRoom.text+'&p_payment_method='+lstPaymentMethod.value+'&p_partner_PK='+txtCompany_PK.text +"&p_time_frm=" +  txtFromTime.text+"&p_time_to=" +  txtToTime.text+"&p_cashier=" +  txtCashier.text;
...
{		
	if(obj=='customer_s')
	{
		var path = System.RootURL + "/standard/forms/60/24/60240010_bus.aspx?";
