...
<script>
 ...
 {       
      ...
      var data = "<%=CtlLib.SetListDataSQL("select pk, grp_cd || ' - ' || grp_nm from comm.tco_itemgrp where del_if = 0 and use_yn = 'Y' order by grp_cd ")%>||";     
...
<body>     
    ...
    <gw:data id="data_epbp00270" onreceive="OnDataReceive(this)"> 
        <xml>
           <dso  type="grid" user="prod"  function="st_lg_sel_epbp00270" >
