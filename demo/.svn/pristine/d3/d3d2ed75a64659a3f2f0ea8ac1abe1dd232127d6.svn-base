...
<body style="margin:0; padding:0;">
	...
	<xml>
		<dso type="grid" function="ac_SEL_60050010_popup_PARTNER" >
			<input bind="idGrid">
	...
	<tr>
		...
		<td width=40%>
		    ...
		    <tr>
		        <td width=35%><gw:textbox id="txtCustomerID"    onenterkey="OnSearch1()"	csstype="mandatory"   styles="width:100%"  /></td>
				  <td width=55%><gw:textbox id="txtCustomerName"   onenterkey="OnSearch1()" 	csstype="mandatory"  styles="width:100%"  /></td>
...
<gw:textbox id="txtTaxcode"    	 styles="width:100%;display:none"  />
</body>
</html>
