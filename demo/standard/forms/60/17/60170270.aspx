...
function OnPopUp(iObj)
{
    ...
    case 'Account':
            ...
            var path = System.RootURL + "/standard/forms/60/03/60030010_popup_ifrs.aspx?comm_code=&comm_nm=&dsqlid=SP_SEL_fmgf00050_3&val1=" + lstCompany.value + "&val2=" + lstWH.value + "&val3=" ;
    ...
    case 'PL':
            ...
            var path = System.RootURL + "/standard/forms/60/05/60050010_popup_2005.aspx?dsqlid=SP_SEL_fmgf00050_2&company=" + lstCompany.value + "&col_code=PL Code&col_nm=PL Name&comm_nm=" +  + "&val1=" + lstWH.value ;
            var object = System.OpenModal( path ,800 , 600 ,  'resizable:yes;status:yes');        
            if(object != null)
            {
...
<body>
  ...
  <gw:data id="fmgf00250" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid"  function="AC_SEL_60170270" > 
                <input bind="idGrid" >                 
    ...
    <!-------------------------------------------------------------------->
     <gw:data id="dso_inout_upd" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="AC_PRO_60170270_TMP" > 
                <input>
                   <input bind="lstCompany" />
                   <input bind="dtFrom"/>
                   <input bind="dtTo"/>
	...
	<!-------------------------------------------------------------------->   
     <gw:data id="dso_remove_data" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="AC_PRO_60170270_1" > 
                <input>
                   <input bind="lstCompany" />
                   <input bind="dtFrom"/>
                   <input bind="dtTo"/>
	...
	<!-------------------------------------------------------------------->   	
     <gw:data id="dso_make_slip" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="AC_PRO_6017270_MAKE_SLIP" > 
                <input>
                   <input bind="lstCompany" />
    ...
    <gw:data id="dso_cancel_slip" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="AC_PRO_6017270_CANCEL_SLIP" > 
                <input>
                   <input bind="lstCompany" />
                   <input bind="txtSeq"/>
				   <input bind="lstWH"/>
    ...
    <gw:data id="dso_search_seq" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="AC_PRO_60170270_2" > 
                <input>
                   <input bind="lstCompany" />
				   <input bind="dtTo"/>
				   <input bind="lstWH"/>
...
<gw:textbox id="txtItem_Pk"  style="display:none" />
</body>
</html>