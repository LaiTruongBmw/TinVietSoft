...
public partial class rpt_60300010_market_segment_date_from_to : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_60300010_market_segment_date_from_to.xls";
        string TempFile = "../../../../system/temp/rpt_60300010_market_segment_date_from_to_" + Session["User_ID"].ToString() + ".xls";
        ...
        dt = CtlLib.TableReadOpenCursor("rpt_60300010_marketseg_frm_to", para);
        //-----header---   
