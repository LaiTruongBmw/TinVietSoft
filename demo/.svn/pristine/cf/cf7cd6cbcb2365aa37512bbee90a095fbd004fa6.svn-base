...
{ 
    ...
    //
    data = "<%=CtlLib.SetListDataFUNC("SELECT F_COMMONCODE('ACAB0070','','') FROM DUAL")%>";
...
function onRowDoubleclk(index)
{
    switch(index)
    {
        case 0:
            ...
            {
                var fpath = System.RootURL + "/standard/forms/60/03/60030070_1.aspx?TAC_ABTRTYPE_pk=" + txtMaster_pk.GetData();
...
<!------------------------------------------------------------------------------->
 <gw:data id="data_gfnt00070_1" onreceive="OnDataReceive(this)"> 
        <xml> 
           <dso type="grid" function="ac_SEL_60050010_ABTRTYPE" parameter="0,1,2,3"> 
 ...
 <!----------------------------------------------------------------------------->
   <gw:data id="data_gfnt00070_2" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" parameter="0,1,5,6" function="ac_sel_60050010_2" procedure="ac_upd_60050010_2">
				    ...
				    <table  border="0" width="100%" cellpadding="0" cellspacing="2"  >
					    ...
					    <tr>
							...
							<td width="5%" align=right>
							    <table >
							        <tr>
							            <td ><gw:button id="ibtnReset" img="new" alt="new"	onclick="OnNew()"  	/></td>
						                <td ><gw:button id="ibtnUpdate" img="save" alt="save" 	onclick="OnSave()" 	 /></td>
