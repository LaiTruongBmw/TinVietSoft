...
public partial class rpt_bisc00171_ST01 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		{
			exSheet.Cells["G6"].Value = dtMaster.Rows[0]["date01"];
			...
			exSheet.Cells["G6"].Value = dtMaster.Rows[1]["date01"];
            exSheet.Cells["I6"].Value = dtMaster.Rows[1]["date02"];
            exSheet.Cells["J6"].Value = dtMaster.Rows[1]["date03"];
            exSheet.Cells["K6"].Value = dtMaster.Rows[1]["date04"];
            exSheet.Cells["L6"].Value = dtMaster.Rows[1]["date05"];
			exSheet.Cells["M6"].Value = dtMaster.Rows[1]["date06"];
			exSheet.Cells["N6"].Value = dtMaster.Rows[1]["date07"];
			exSheet.Cells["O6"].Value = dtMaster.Rows[1]["date08"];
			exSheet.Cells["P6"].Value = dtMaster.Rows[1]["date09"];
			exSheet.Cells["Q6"].Value = dtMaster.Rows[1]["date10"];
			exSheet.Cells["R6"].Value = dtMaster.Rows[1]["date11"];
			exSheet.Cells["S6"].Value = dtMaster.Rows[1]["date12"];
			exSheet.Cells["T6"].Value = dtMaster.Rows[1]["date13"];
			exSheet.Cells["U6"].Value = dtMaster.Rows[1]["date14"];
			exSheet.Cells["V6"].Value = dtMaster.Rows[1]["date15"];
			exSheet.Cells["W6"].Value = dtMaster.Rows[1]["date16"];
			exSheet.Cells["X6"].Value = dtMaster.Rows[1]["date17"];
			exSheet.Cells["Y6"].Value = dtMaster.Rows[1]["date18"];
			exSheet.Cells["Z6"].Value = dtMaster.Rows[1]["date19"];
			exSheet.Cells["AA6"].Value = dtMaster.Rows[1]["date20"];
			exSheet.Cells["AB6"].Value = dtMaster.Rows[1]["date21"];
			exSheet.Cells["AC6"].Value = dtMaster.Rows[1]["date22"];
			exSheet.Cells["AD6"].Value = dtMaster.Rows[1]["date23"];
			exSheet.Cells["AE6"].Value = dtMaster.Rows[1]["date24"];
			exSheet.Cells["AF6"].Value = dtMaster.Rows[1]["date25"];
			exSheet.Cells["AG6"].Value = dtMaster.Rows[1]["date26"];
			exSheet.Cells["AH6"].Value = dtMaster.Rows[1]["date27"];
			exSheet.Cells["AI6"].Value = dtMaster.Rows[1]["date28"];
			exSheet.Cells["AJ6"].Value = dtMaster.Rows[1]["date29"];
			exSheet.Cells["AK6"].Value = dtMaster.Rows[1]["date30"];
			exSheet.Cells["AL6"].Value = dtMaster.Rows[1]["date31"];
		}
        ...
        for (int i = 0; i < dtDetail.Rows.Count; i++)
        {
			...
			exSheet.Cells[l_pos , 7].Value = dtDetail.Rows[i]["end_qty"];         
        ...
        exSheet.Cells[l_pos, 5].Value = 99999;// p_begin;
