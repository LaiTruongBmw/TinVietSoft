...
<gw:data id="dso_upd_grd" onreceive="OnDataReceive(this)">
	<xml>
		<dso type="grid" parameter="0,1,4" function="ac_sel_60010140_popup" procedure="ac_UPD_60010140_1">
			<input bind="idGrid" >
...
<gw:data id="dso_udp_ctl_mst" onreceive="OnDataReceive(this)"> 
	<xml>
		<dso  type="process"   procedure="ac_UPD_60010140_save"  > 
			<input>
				<input bind="txtAllocation_Criteria_group" />
				<input bind="txtPL_pk" />
			</input> 
...
<table style="margin-left:5;height:100%" align="center" width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr style="height:95%">
        <td colspan = "9">
					            ...
					            <gw:grid  
							    id="idGrid"  
							    header="_pk|Allocation Criteria Group|PL Code|PL Name|_PK_PL"
							    format="0|0|0|0|0"
							    aligns="1|0|0|0|0"  
							    defaults="|||||"  
							    editcol="0|0|0|0|0"  
							    widths="0|1000|2000|1000|0"  
