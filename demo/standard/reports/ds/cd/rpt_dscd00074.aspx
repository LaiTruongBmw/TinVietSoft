...
<%    
    ...
    dt  = CtlLib.TableReadOpenCursor("st_lg__rpt_dscd00074");
    dt1 = CtlLib.TableReadOpenCursor("st_lg__rpt_dscd00074_1", para);
    dt2 = CtlLib.TableReadOpenCursor("st_lg__rpt_dscd00074_2", para);
%>
...
<link rel=File-List href="rpt_dscd00074_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_dscd00074_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_dscd00074_files/oledata.mso">
<!--[if !mso]>
<style>
...
<![endif]--><!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2012-05-16T09:31:19Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=810 style='border-collapse:
 ...
 <tr class=xl26 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl27 width=30 style='height:15.0pt;width:23pt'></td>
 ...
 <tr class=xl32 height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  class="font5">Ngày</font><font class="font10"> <%= dt1.Rows[0]["out_dd"]%></font><font class="font5">
  Tháng </font><font class="font10"><%= dt1.Rows[0]["out_mm"]%></font><font class="font5"> N&#259;m </font><font
  class="font10"><%= dt1.Rows[0]["out_yy"]%></font></td>
 </tr>
 <tr class=xl32 height=30 style='mso-height-source:userset;height:22.5pt'>
  <td colspan=2 height=30 class=xl57 width=120 style='height:22.5pt;width:91pt'>Xu&#7845;t
  cho <font class="font9">Outgo To</font></td>
  <td colspan=2 class=xl58><%= dt1.Rows[0]["partner_name"]%></td>
  <td colspan=2 class=xl59>N/Viên<font class="font9"> Charger</font></td>
  <td colspan=3 class=xl60><%= dt1.Rows[0]["full_name"]%></td>
 </tr>
 <tr class=xl32 height=30 style='mso-height-source:userset;height:22.5pt'>
  <td colspan=2 height=30 class=xl57 width=120 style='height:22.5pt;width:91pt'>Di&#7877;n
  gi&#7843;i <font class="font9">Remark</font></td>
  <td colspan=2 class=xl61><%= dt1.Rows[0]["description"]%></td>
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td rowspan=2 class=xl64 width=90 style='border-bottom:.5pt solid black;
  width:68pt'>Thành ti&#7873;n <%= dt1.Rows[0]["tr_ccy"]%><br>
 ...
 <tr height=35 style='mso-height-source:userset;height:26.25pt'>
  <td height=35 class=xl35 width=30 style='height:26.25pt;width:23pt' x:num><%= dt2.Rows[i]["seq"]%></td>
  <td class=xl37 width=90 style='width:68pt'  ><%= dt2.Rows[i]["item_code"]%></td>
  <td class=xl38 width=230 style='width:173pt'><%= dt2.Rows[i]["item_name"]%></td>
  <td class=xl39 width=45 style='width:34pt'><%= dt2.Rows[i]["uom"]%></td>
 ...
 <tr height=35 style='mso-height-source:userset;height:26.25pt'>
  ...
  style='mso-spacerun:yes'>                            </span><%= dt1.Rows[0]["item_amount"]%> </td>
  <td class=xl50   style='border-top:.5pt solid black' ><%= dt1.Rows[0]["tr_ccy"]%></td>
 </tr>
 <tr height=35 style='mso-height-source:userset;height:26.25pt'>
  ...
  style='mso-spacerun:yes'>                            </span> <%= dt1.Rows[0]["tax_amount"]%> </td>
  <td class=xl50><%= dt1.Rows[0]["tr_ccy"]%></td>
 </tr>
 <tr height=35 style='mso-height-source:userset;height:26.25pt'>
  ...
  <td class=xl51><%= dt1.Rows[0]["tr_ccy"]%></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td height=17 colspan=9 class=xl25 style='height:12.75pt;mso-ignore:colspan'></td>
 </tr>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  </v:shapetype><v:shape id="_x0000_s3083" type="#_x0000_t75" style='position:absolute;
   margin-left:124.5pt;margin-top:9.75pt;width:364.5pt;height:102pt;z-index:1'>
   <v:imagedata src="rpt_dscd00074_files/image001.png" o:title=""/>
  ...
  position:absolute;z-index:1;margin-left:166px;margin-top:13px;width:486px;
  height:136px'><img width=486 height=136 src="rpt_dscd00074_files/image002.jpg"
