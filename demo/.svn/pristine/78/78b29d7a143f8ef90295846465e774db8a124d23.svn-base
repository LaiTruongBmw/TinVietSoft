...
public partial class rpt_60280020_rvn_laundry_detail : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_60280020_rvn_laundry_detail.xls";
        string TempFile = "../../../../system/temp/rpt_60280020_rvn_laundry_detail_" + Session["User_ID"].ToString() + ".xls";
        ...
        para = "'" + l_from + "','" + l_to + "'";
        dt = CtlLib.TableReadOpenCursor("rpt_60280020_rvn_laundry", para);
        //-----header---   
