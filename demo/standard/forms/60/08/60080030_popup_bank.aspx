...
function BodyInit()
{
    ...
    var idCompany= "<%=Request.querystring("company")%>";
    var idvalue1 = "<%=Request.querystring("val1")%>";
    var idvalue2 = "<%=Request.querystring("val2")%>";
    var idvalue3 = "<%=Request.querystring("val3")%>";
    ...
    if(idDsql != "ac_sel_60080030_pl_popup" && idDsql != "ac_sel_60080030_pl_popup_plpk" && idDsql != "ac_sel_60080030_pl_popup_ct_pk" )	 
    {
...
<body>
    ...
    <gw:data id="idData_Dsql" onreceive="" >
        <xml>
            <dso type="grid" parameter="0,1" function="<%=Request.querystring("dsqlid")%>">
                <input bind="idGrid" >
                    <input bind="idcode"/>
                    <input bind="idname"/>
                    <input bind="txtItem"/>
...
<gw:textbox id="txtAcc_Pk"     styles="width:100%;height:25" style="display:none"/>
</body>
