...
function BindingDataList()
{
	...
	var ls_BizPlace      = "<%=CtlLib.SetListDataSQL("select pk, loc_nm from tco_busplace where del_if = 0")%>";
	var ls_Report_Type    = "<%=CtlLib.SetListDataSQL("SELECT D.CODE, D.CODE_NM FROM TAC_COMMCODE_MASTER M, TAC_COMMCODE_DETAIL D WHERE M.PK = D.TAC_COMMCODE_MASTER_PK AND M.ID = 'ACBG0211' AND M.DEL_IF = 0 AND D.DEL_IF = 0 and d.use_yn = 'Y'  ORDER BY D.CODE_NM")%>"; 
...
function OnReport()
{
            ...
            switch (lstReport_Type.GetData() )
            {
                case "TT28":
                    //var url = '/standard/reports/gf/lv/gflv00020_rpt_VAT_In1.aspx?compk=' + lstCompany.GetData();
					 var url = '/standard/reports/60/12/60120120_rpt_VAT_In_new.aspx?compk=' + lstCompany.GetData();	
                ...
                break;
                case "TT156":
					var url = '/standard/reports/60/12/rpt_60120120_rpt_VAT_In_new_156.aspx?compk=' + lstCompany.GetData();	
                     url = url + '&month=' + dtMonth.GetData() + '&vat_type=' + lstTypeINOUT.GetData();
                     url = url + '&vat_rate='+ txtTaxRate.GetData() +  '&ccy=' + lstCurrent.GetData();
                     url = url + '&status=' + lstStatus.GetData() + '&custpk=' + txtCUST_PK.GetData();
                     url = url + '&invoiceno=' + txtINVOICENO.text + '&ac_cd=' + txtAC_CD.text;
        ...
        else
        {
            ...
            {	
				case "TT28":
					var url = '/standard/reports/60/12/60120120_rpt_VAT_Out_New.aspx?compk=' + lstCompany.GetData();
					 url = url + '&month=' + dtMonth.GetData() + '&vat_type=' + lstTypeINOUT.GetData();
					 url = url + '&vat_rate='+ txtTaxRate.GetData() +  '&ccy=' + lstCurrent.GetData();
					 url = url + '&status=' + lstStatus.GetData() + '&custpk=' + txtCUST_PK.GetData();
					 url = url + '&invoiceno=' + txtINVOICENO.text + '&ac_cd=' + txtAC_CD.text;
				...
				break;
				case "TT156":
					var url = '/standard/reports/60/12/rpt_60120120_rpt_VAT_Out_New_156.aspx?compk=' + lstCompany.GetData();
					 url = url + '&month=' + dtMonth.GetData() + '&vat_type=' + lstTypeINOUT.GetData();
					 url = url + '&vat_rate='+ txtTaxRate.GetData() +  '&ccy=' + lstCurrent.GetData();
					 url = url + '&status=' + lstStatus.GetData() + '&custpk=' + txtCUST_PK.GetData();
					 url = url + '&invoiceno=' + txtINVOICENO.text + '&ac_cd=' + txtAC_CD.text;
...
function OnReport2()
{
        if(lstTypeINOUT.GetData()=="1")
        {
            ...
            {	
				case "TT28":
					//var url = '/standard/reports/gf/lv/gflv00400_import_VAT_in_New.aspx?com=' + lstCompany.GetData() + '&yyyymm=' + dtMonth.GetData() + '&status=' + lstStatus.GetData() + '&vat_rate='+ lstRATE.GetData() + '&ccy=' + lstCurrent.GetData() + '&cust_pk=' + txtCUST_PK.GetData()+'&acc_pk='+txtac_pk.text;
					var url = '/standard/reports/60/12/60120120_rpt_import_VAT_in.aspx?com=' + lstCompany.GetData() + '&yyyymm=' + dtMonth.GetData() + '&status=' + lstStatus.GetData() + '&vat_rate='+ lstRATE.GetData() + '&ccy=' + lstCurrent.GetData() + '&cust_pk=' + txtCUST_PK.GetData()+'&acc_pk='+txtac_pk.text + '&voucher_type=' + lstvoucher.GetData() + '&Biz_Place=' + lstBiz_Place.value+'&From='+dtfrdate.value+'&To='+dttodate.value; 
					
				break;
				case "TT156":
					var url = '/standard/reports/60/12/rpt_60120120_rpt_import_VAT_in_156.aspx?com=' + lstCompany.GetData() + '&yyyymm=' + dtMonth.GetData() + '&status=' + lstStatus.GetData() + '&vat_rate='+ lstRATE.GetData() + '&ccy=' + lstCurrent.GetData() + '&cust_pk=' + txtCUST_PK.GetData()+'&acc_pk='+txtac_pk.text + '&voucher_type=' + lstvoucher.GetData() + '&Biz_Place='+ lstBiz_Place.value +'&From='+dtfrdate.value+'&To='+dttodate.value; 
					
				break;
				case "TT119":
					var url = '/standard/reports/60/12/rpt_60120120_rpt_import_VAT_in_119.aspx?com=' + lstCompany.GetData() + '&yyyymm=' + dtMonth.GetData() + '&status=' + lstStatus.GetData() + '&vat_rate='+ lstRATE.GetData() + '&ccy=' + lstCurrent.GetData() + '&cust_pk=' + txtCUST_PK.GetData()+'&acc_pk='+txtac_pk.text + '&voucher_type=' + lstvoucher.GetData() + '&Biz_Place='+ lstBiz_Place.value +'&From='+dtfrdate.value+'&To='+dttodate.value; 
        ...
        else
        {
            ...
            {	
				case "TT28":
					var url = '/standard/reports/60/12/60120120_import_VAT_Out_New.aspx?com=' + lstCompany.GetData() + '&yyyymm=' + dtMonth.GetData() + '&status=' + lstStatus.GetData() + '&vat_rate='+ lstRATE.GetData() + '&ccy=' + lstCurrent.GetData() + '&cust_pk=' + txtCUST_PK.GetData()+'&acc_pk='+txtac_pk.text+'&From='+dtfrdate.value+'&To='+dttodate.value+ '&Biz_Place=' + lstBiz_Place.value; 
					
				break;
				case "TT156":
					var url = '/standard/reports/60/12/rpt_60120120_rpt_import_VAT_out_156.aspx?com=' + lstCompany.GetData() + '&yyyymm=' + dtMonth.GetData() + '&status=' + lstStatus.GetData() + '&vat_rate='+ lstRATE.GetData() + '&ccy=' + lstCurrent.GetData() + '&cust_pk=' + txtCUST_PK.GetData()+'&acc_pk='+txtac_pk.text+'&From='+dtfrdate.value+'&To='+dttodate.value+ '&Biz_Place='+ lstBiz_Place.value; 
				break;
				case "TT119":
					var url = '/standard/reports/60/12/rpt_60120120_rpt_import_VAT_out_119.aspx?com=' + lstCompany.GetData() + '&yyyymm=' + dtMonth.GetData() + '&status=' + lstStatus.GetData() + '&vat_rate='+ lstRATE.GetData() + '&ccy=' + lstCurrent.GetData() + '&cust_pk=' + txtCUST_PK.GetData()+'&acc_pk='+txtac_pk.text + '&voucher_type=' + lstvoucher.GetData() + '&Biz_Place='+ lstBiz_Place.value +'&From='+dtfrdate.value+'&To='+dttodate.value; 
		...
		{
			var url = '/standard/reports/60/12/rpt_60120120_pl3.aspx?com='+ lstCompany.GetData() + '&From='+dtfrdate.value+'&To='+dttodate.value;
		}	
        System.OpenTargetPage( System.RootURL+url , 'newform' )
}
function RowClick()
...
//    } 
    ...
    if (rownum > 0) 
    {
        var fpath = System.RootURL + '/standard/forms/60/09/60090030_popup.aspx?PK_ROW=' + pk + '&ROW=' + rownum + '&ROWS=' + rows + '&APPRCANCEL=' + status + "&ARRAY_PK=" + ls_arr;
        var wWidth = 950;
        var wHeight = 600;
...
function OnGetAccount(){
    var fpath = System.RootURL + "/standard/forms/60/08/60080050_popup_Acc.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + 'Y' + "&val2=" + 'Y' + "&val3=" + lstCompany.GetData() + "&dsqlid=ac_sel_60080050_acct";
