...
{
	var path = System.RootURL + '/standard/forms/gf/hg/gfhg00020_1.aspx?com_pk='+ lstCompany.GetData() + '&seq=' + txtseq.GetData() + '&status=' + txtStatus.GetData() + '&userid=' + txtProposedByUserID.GetData() + '&usernm=' + txtProposedByUserName.GetData() + '&userpk=' + txtProposedByUserPk.GetData() + '&dsqlid=SP_PRO_CTL_MST_CONFIRM_CANCEL' + '&table=TAC_HGTRH';
...
<!------------------------------------------------------------------------------------------------------->
 ...
 <gw:data id="dso_udp_ctl_mst_slip_entry" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="control" function="SP_SEL_CTL_MST_SLIP_ENTRY">
            <inout> 
                <inout bind="txtseq"/>
    ...
    <gw:data id="dso_sel_grd_dtl_slip_entry_dr" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" function="SP_SEL_GRD_DTL_SLIP_ENTRY">
                <input bind="grdDebit" >
                    <input bind="txtseq"/>
    ...
    <gw:data id="dso_sel_count_ctl_item" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="SP_PRO_GRD_DTL_CNT_SLIP_ENTRY" > 
                <input> 
                     <input bind="txtacpk"/>
                     <input bind="txt_drcr_type"/>
                     <input bind="txthgtrd"/>
    ...
    <gw:data id="dso_sel_control_new_item" onreceive="ItemStyle()">
        <xml>
            <dso type="grid" function="SP_SEL_GRD_CTL_ITEM_SLIP_ENTRY" >
    ...
    <gw:data id="dso_upd_approval_cancel" onreceive="SetButtonEnable()"> 
        <xml> 
            <dso type="process" procedure="SP_PRO_CTL_MST_APPROVAL_CANCEL" > 
                <input> 
