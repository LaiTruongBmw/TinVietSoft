...
public partial class rpt_hrti01600_0 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string  p_tco_org_pk, p_employee, p_absence_type, p_from_date, p_to_date, p_wg, p_ws, p_nation;
		 
	  
		p_tco_org_pk        = Request["p_tco_org_pk"].ToString();
		p_ws          		= Request["p_ws"].ToString();
		p_employee 			= Request["p_search_temp"].ToString();
        ...
        string TemplateFile = "rpt_hrti01600_0.xls";
        string TempFile = "../../../../system/temp/rpt_hrti01600_0_" + Session["User_ID"].ToString() + ".xls";
		...
		string para = "'" + p_employee + "','" + p_from_date + "','" + p_to_date + "','"+ p_tco_org_pk  + "','" + p_ws + "','" + p_nation  +"'";
		
		DataTable dt_emp = CtlLib.TableReadOpenCursor("ST_HR_RPT_HRTI01600_0", para);
		...
		exSheet.Cells["A1"].Value = "BIỂU THỜI GIAN LÀM VIỆC NGÀY: "+ dt_emp.Rows[0][0].ToString() +" - "+ dt_emp.Rows[0][1].ToString();
