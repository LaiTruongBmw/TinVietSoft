...
<%
    ...
    DataTable dt = CtlLib.TableReadOpenCursor("ht_rpt_60250040", l_parameter);
    if (dt.Rows.Count == 0)
    {
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1574 style='border-collapse:
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl26 colspan="2"><%=l_print_date%></td>
 </tr>
 ...
 <tr height=18 style='mso-height-source:userset;height:13.5pt'>
  ...
  <td class=xl31 style='height:13.5pt;border-top:none;<%=l_color%>'><%=dt.Rows[i]["nation"]%></td>
 </tr>
  <%}%>
