...
public partial class rpt_bini00190_0 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_bini00190_0.xls";
        string TempFile = "../../../../system/temp/rpt_bini00190_0_" + Session["User_ID"].ToString() + ".xls";
        ...
        DataTable dt_com = CtlLib.TableReadOpenCursor("lg_rpt_bini00190_0_0", para);
		DataTable dt_master = CtlLib.TableReadOpenCursor("lg_rpt_bini00190_0_1", para);
		DataTable dt_detail = CtlLib.TableReadOpenCursor("lg_rpt_bini00190_0_2", para);
		...
		exSheet.Cells["H1"].Value = "Tel: " +dt_com.Rows[0]["tel"];
		exSheet.Cells["H2"].Value = "Fax: " +dt_com.Rows[0]["fax"];
		exSheet.Cells["H3"].Value = "Print Date: " +dt_com.Rows[0]["print_dt"];
		...
		exSheet.Cells[row_loop + count + 2, 8].Value = "Ngày "+ dt_master.Rows[0]["ins_day"].ToString() +" Tháng "+ dt_master.Rows[0]["ins_mon"].ToString() + " Năm "+ dt_master.Rows[0]["ins_year"].ToString();
