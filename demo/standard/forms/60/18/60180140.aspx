...
function OnPopUp(pname)
{
    if (pname=='ACCT')
   {
         var fpath = System.RootURL + "/standard/forms/60/18/60180140_popup.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + 'Y' + "&val2=" + 'Y' + "&val3=" + lstCompany.GetData() + "&dsqlid=AC_SEL_60180110_11";
    ...
    if (pname=='CENTER')
   {
        var fpath   = System.RootURL + "/standard/forms/gf/co/gfco002005.aspx?comm_code="+ "" + "&comm_nm=" + '' + "&company=" + lstCompany.GetData() + '&dsqlid=ac_sel_60080140_pp_centerpk&col_code=' + "PL CODE" + '&col_nm=' + "PL NAME";            
    ...
    switch(lang)
    {
        case "ENG":
            ...
            if(confirm("Are you sure you want to report ?" ))
            {
                ...
                {
                    case "AS":
                        url = '/standard/reports/60/18/60180140_DailyEntryInq_ENG.aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
                    ...
                    break;
                    case "S03a-DN":
                        url ='/standard/reports/60/18/60180140_SoNKC_S03a-DN_ENG.aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
                        url= url+'&Seq='+txtSeq.text+'&Company='+lstCompany.value+'&Status='+rdoSlipStatus.value+'&BookCcy='+lstBookCcy.value;
                    break;
                     case "S03a-DN-TNDN":
                        url ='/standard/reports/60/18/60180140_SoNKC_S03a-DN-TNDN.aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
                        url= url+'&Seq='+txtSeq.text+'&Company='+lstCompany.value+'&Status='+rdoSlipStatus.value+'&BookCcy='+lstBookCcy.value;
                    break;
                    case "S03a-DN-PHT":
                         url ='/standard/reports/60/18/60180140_SoNKC_S03a-DN_phieuHToan.aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
                         url= url+'&Seq='+txtSeq.text+'&Company='+lstCompany.value+'&Status='+rdoSlipStatus.value+'&BookCcy='+lstBookCcy.value;
                    break;
                    case "tmp":
                         url ='/standard/reports/60/18/60180140_SoNKC_S03a-DN-TNDN(Invalid).aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
                         url= url+'&Seq='+txtSeq.text+'&Company='+lstCompany.value+'&Status='+rdoSlipStatus.value+'&BookCcy='+lstBookCcy.value;
                   break;
                }
         ...
         if(confirm("Are you sure you want to report ?" ))
            {
                ...
                {
                    case "AS":
                        url = '/standard/reports/60/18/60180140_DailyEntryInq_VN.aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
                        url= url+'&Seq='+txtSeq.text+'&Company='+lstCompany.value+'&Status='+rdoSlipStatus.value+'&BookCcy='+lstBookCcy.value+'&Lang='+lstLanguage.value;
                    break;
                    case "S03a-DN":
                        url ='/standard/reports/60/18/60180140_SoNKC_S03a-DN.aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
                        url= url+'&Seq='+txtSeq.text+'&Company='+lstCompany.value+'&Status='+rdoSlipStatus.value+'&BookCcy='+lstBookCcy.value;
                    break;
                     case "S03a-DN-TNDN":
                        url ='/standard/reports/60/18/60180140_SoNKC_S03a-DN-TNDN.aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
...
<gw:data id="datDaily_Entry_Inquiry" onreceive="OnDataReceive(this)" onerror="OnDataError(this)">
        <xml>
            <dso type="grid"  function="AC_SEL_60180140_1">
   ...
   <gw:data id="datDaily_Entry_Inquiry_Sum" onreceive="OnDataReceive(this)" onerror="OnDataError(this)">
        <xml>
            <dso type="grid"  function="AC_SEL_60180140_2">
   ...
   <gw:data id="datDaily_Entry_Inquiry_TotalDC" onreceive="OnDataReceive(this)" onerror="OnDataError(this)">
        <xml>
            <dso type="process"  procedure ="AC_SEL_60180140_3" >
            <input>
            <input bind="lstCompany" />
            <input bind="dtbFrom"/>
            <input bind="dtbTo" />
...
<table width="100%">
      ...
      <fieldset>
            ...
            <td  width="20%" ><gw:textbox id="txtVoucher_No" styles="width:100%"  onenterkey="onSearch()"/></td>
             ...
             <td width="19%" colspan="4"><gw:textbox id="txtSeq" styles="width:100%" onenterkey="onSearch()"  /></td>
            <td ><gw:imgBtn id="ibtnSearch" img="search"    alt="Search"    onclick="onSearch()" /></td>
               
                <td ><gw:button id="btnReport"  text="Print" img="excel" alt="Print Acct"  onclick="OnPrint(lstLanguage.GetData())" /> 
				<gw:imgBtn id="ibtnReport" img="printer"   alt="Print Acct"styles='display:none'  onclick="OnReport(lstLanguage.GetData())" /></td>
            </tr>
            <tr>
