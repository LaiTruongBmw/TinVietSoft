 ...
 function OnReport(n)
{
	...
	{
		case 1:			
			var url =System.RootURL + '/standard/reports/ht/fo/htfo00170_Room_Status_hsekeeping.aspx';
		...
		break;
		case 3: 
			var url =System.RootURL + '/standard/reports/ht/fo/rpt_htfo00170_Room_Status_Village.aspx';
			System.OpenTargetPage(url);	 			
		break;
		case 4: 			
			 var url = '/standard/reports/60/26/rpt_60260030_worksheet.aspx?p_floor_worksheet='+ lstFloorWorksheet.value+"&p_date="+dtDate.value;
...
<body>
    <gw:data id="data_DataHide" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="grid" function="st_ht_sel_60260030_room_map">  
                <input >  
                </input>
