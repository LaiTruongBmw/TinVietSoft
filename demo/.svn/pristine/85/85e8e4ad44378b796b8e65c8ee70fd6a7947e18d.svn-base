...
//============================================================================== 
 ...
 {      
     ...
     lstPaymentMethod.SetDataText("<%=CtlLib.SetListDataSQL("SELECT code,NAME FROM tco_commcode WHERE DEL_IF=0 and  parent_code='PTYPE' and use_yn='Y' and code in('PTYPE-01','PTYPE-02','PTYPE-04')" )%>");
