...
<gw:data id="dso_getCompany" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="list" procedure="ac_sel_60130120_entry" >  
                <input> 
...
<!------------------------------------------------------------------------>
 <gw:data id="dso_pro_fa_depreciation" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" parameter="0,1,2" procedure="ac_pro_60130120fa_depreciation" > 
                <input> 
                     <input bind="txtType"/>
  ...
  <gw:data id="dso_pro_fa_generate" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" parameter="0,1" procedure="ac_pro_60130120_fa_generate2" > 
                <input> 
                     <input bind="lstCOMPANY"/>
                     <input bind="txtMonth"/>
					<input bind="lstAsset_Type"/>
    ...
    <gw:data id="dso_pro_fa_cancelslip" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" parameter="0,1" procedure="ac_pro_60130120_fa_cancelslip" > 
                <input> 
                     <input bind="lstCOMPANY"/>
                     <input bind="txtMonth"/>
					<input bind="lstAsset_Type"/>
    ...
    <gw:data id="dso_sel_fa_depreciation" onreceive="OnDataReceive(this)" >
        <xml>
            <dso type="grid" function="ac_sel_60130120_fa_depreciate">
                <input bind="grid">
                    <input bind="lstCOMPANY"/>
                     <input bind="txtMonth"/>
 ...
 <td>
                    <table border="0"  cellpadding=0 cellspacing=0 width="100%" >
			            <tr>
                            ...
                            <td style="width:40% " align="right">Type</td>
                            <td style="width:60% " colspan=''><gw:list id="lstAsset_Type" styles="width: 100%" onchange="OnSearch()" /></td>
                        </tr>
                    </table>
                </td>
				<td >&nbsp;</td>
		        ...
		        <td colspan=3><gw:textbox id="txtAssetCode"  styles='width:100%;' onenterkey="OnSearch();"/></td>
			</tr>
		</table>
		</fieldset> </td>
		<td width="10%">
		    <fieldset style="padding: 2;height:80px" >
