...
function BodyInit()
{
	var ls_Cust_PK   = "<%=Request.querystring("p_Cust_PK")%>";
	var ls_Custto_id   = "<%=Request.querystring("p_Custto_id")%>";
	var ls_Custto_name   = "<%=Request.querystring("p_Custto_name")%>";
	txtcustpk.text = ls_Cust_PK;
    txtcustid.text = ls_Custto_id;
    txtcustnm.text = ls_Custto_name;
...
<gw:data id="datGetBeneBankList"> 
    <xml> 
        <dso  type="grid" function="ac_sel_60050010_BFBENEFICIARY"> 
	    ...
	    <td width="100%">
	     <fieldset style="width: 100%; height: 100%; padding: 2">
	        <table border="0" width="100%" cellpadding="0" cellspacing="0"  id="table1">
              ...
              <td width="15%" align=Right>BeneBank</td>
