...
<body>
    ...
    <gw:data id="data_fpfo00060_attach_file" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" parameter="0" function="st_lg_sel_epbp00010_file" procedure = "PROD.sp_upd_epbp00010_file" > 
                <input bind="grdFiles" >
    ...
    <!---------------------------------------------------------------------------------------------->
            <table  width="100%"  height="100%" border="0">
	            <tr style="height:10%">	 
		            ...
		            <td width="3%" ><gw:button img="attach" alt="Attach file" id="btnAttach" onclick="OnAttach()"  /></td> 
		            <td width="3%" ><gw:button img="delete" alt="Delete file" id="btnDelete" onclick="OnDelete()" /></td>
	            </tr>
	            <tr style="height:90%">
	                <td colspan="3">
	                    <gw:grid id="grdFiles" 
