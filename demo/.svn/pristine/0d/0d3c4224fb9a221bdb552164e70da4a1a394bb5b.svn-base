...
<%    
    ...
    dt1 = CtlLib.TableReadOpenCursor("SALE.sp_rpt_dscd00012", "'" + date + "','" + searchno + "'");
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1307 style='border-collapse:
 ...
 <tr class=xl68 height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td class=xl66 width=209 style='width:160pt'>VINA GENUWIN</td>
 ...
 <tr class=xl74 height=31 style='mso-height-source:userset;height:23.25pt'>
  ...
  <td class=xl73 width=92 style='width:100pt'>Mã khách hàng<br>
    <font class="font11">Partner Code</font></td>
  <td class=xl73 width=203 style='width:152pt'>Tên khách hàng<br>
    <font class="font11">Partner Name</font></td>
...
<tr class=xl74 height=39 style='mso-height-source:userset;height:29.25pt'>
  ...
  <td class=xl76 width=89 style='width:67pt'><%=dt1.Rows[i]["partner_id"]%></td>
  <td class=xl82 width=203 style='width:152pt'><%=dt1.Rows[i]["partner_name"]%></td>
