...
{
    var obj;
       if (obj_data.id=="datLongTermAbsPopup")
       {
...
<gw:data id="datLongTermAbsPopup" onreceive="OnDataReceive(this)"  > 
        <xml> 
           <dso  type="grid"  function="ST_HR_SEL_HRTI01002_0" > 
            ...
            <td  style="width:100%;height:100%">
                <table width="100%" id="tblexp" style="height:10%" border=0 cellpadding="0" cellspacing="0">
                    <tr style="border:0;width:100%" valign="middle"  >
                        <td width="6%"  align="right" ><a class="eco_link" title="Click here to show Organization" onclick="OnShowPopup()" href="#tips" style="text-decoration: none; color=#0000ff" >Organization</a>                  
                        </td>
                        ...
                        <td width="7%" style="border:0" align="right" valign="middle">Employee</td>
