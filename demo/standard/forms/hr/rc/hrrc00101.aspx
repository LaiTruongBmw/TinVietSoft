        ...
        <td>
            <table cellpadding="0" cellspacing="0" border="0" width="100%" >
                <tr>
                    ...
                    <td width="15%" align="right"><gw:button id="btnSearch" img="search"  alt="search" onclick="OnSearch()" /> </td>
                    <td width="15%" align="right"><gw:button id="btnSearch" img="select"  alt="Select" onclick="OnSelect()" /></td>
                </tr>
            </table>
        </td>
    </tr>
