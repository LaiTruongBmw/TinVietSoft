...
public partial class rpt_hrti01000_0 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if(p_lang == "ENG")
		{
			TemplateFile = "rpt_hrti01000_0_eng.xls";
		}
        else
			TemplateFile = "rpt_hrti01000_0_vie.xls";
        string TempFile = "../../../../system/temp/rpt_hrti01000_0_" + Session["User_ID"].ToString() + ".xls";
        ...
        string para = "'" + p_tco_org_pk + "','" + p_input + "','" + p_absence_type + "','" + p_from_date + "','" + p_to_date + "'";
		
		DataTable dt_emp = CtlLib.TableReadOpenCursor("ST_HR_RPT_HRTI01000_0", para);
