...
<%    
    ...
    dt1 = CtlLib.TableReadOpenCursor("SALE.sp_rpt_dsbs00230", "'" + p_partner_pk + "'");
    dt2 = CtlLib.TableReadOpenCursor("SALE.sp_rpt_dsbs00230_1", para);
%>
<head>
   ...
   <x:ClientData ObjectType="Pict">
    ...
    <x:CF>Bitmap</x:CF>
        ...
        <%
            decimal total = 0;
            decimal subqty = 0;
            decimal sub_unit_price = 0;
            decimal subtotal = 0;
            string strPCS = string.Empty;
            for (int i = 0; i < dt2.Rows.Count; i++)
            {
                if (!strPCS.Equals(dt2.Rows[i]["uom"]) && i != 0)
                {
             %>
            ...
            <td class="xl46" width="62" style='border-top: none; border-left: none; width: 47pt'
                x:num>
            ...
            <td class="xl44" width="101" style='border-top: none; border-left: none; width: 76pt'>
                <%= subtotal %>
            </td>
            ...
            <td colspan="3" class="xl39" style='mso-ignore: colspan'>
             ...
             <%
                 strPCS = dt2.Rows[i]["uom"].ToString();
                 subqty = 0 ;
                 sub_unit_price = 0 ;
                 subtotal = 0 ;   
            }    
        ...
        <%
            ...
            sub_unit_price += Convert.ToDecimal(dt2.Rows[i]["unit_price"]);
            subtotal += Convert.ToDecimal(dt2.Rows[i]["sel_amt"]);
            } %>
        <tr height="32" style='mso-height-source: userset; height: 24.0pt'>
            <td height="32" class="xl51" width="49" style='height: 24.0pt; border-top: none;
                width: 37pt'>
