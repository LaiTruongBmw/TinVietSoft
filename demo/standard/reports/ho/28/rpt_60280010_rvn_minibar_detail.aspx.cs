...
using NativeExcel;
public partial class rpt_60280010_rvn_minibar_detail : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
       CtlLib.SetUser(Session["APP_DBUSER"].ToString());
        ...
        string TemplateFile = "rpt_60280010_rvn_minibar_detail.xls";
        string TempFile = "../../../../system/temp/rpt_60280010_rvn_minibar_detail_" + Session["User_ID"].ToString() + ".xls";
        ...
        para = "'" + l_from + "','" + l_to + "'";
        dt = CtlLib.TableReadOpenCursor("rpt_60280010_rvn_minibar", para);
        //-----header---   
