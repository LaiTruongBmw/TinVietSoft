...
public partial class rpt_60280040_Guest_Invoice : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		{		
				...
				exSheet.Cells[17, 5].Value = int.Parse(dt.Rows[0]["total_amt"].ToString());//
				exSheet.Cells[17, 7].Value = float.Parse(dt.Rows[0]["total_amt_usd"].ToString());
				...
				exSheet.Cells[23, 5].Value = int.Parse(dt.Rows[0]["total_due"].ToString());
