...
function onGetAcc()
{
var fpath = System.RootURL + "/standard/forms/60/19/60190110_popup.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + '' + "&val2=" + '' + "&val3=" + lstCompany.value+'' + "&dsqlid=AC_SEL_60190110_POPUP";
...
//    } 
    ...
    if (rownum > 0) 
    {
        var fpath = System.RootURL + '/standard/forms/60/06/60060030_popup.aspx?PK_ROW=' + pk + '&ROW=' + rownum + '&ROWS=' + rows + '&APPRCANCEL=' + status + "&ARRAY_PK=" + ls_arr;
        var wWidth = 950;
        var wHeight = 600;
...
//		                }
               ...
               /*if (lstReportType.value=="AS")
               {
                    ...
                    {
                        url =System.RootURL + '/standard/reports/60/08/60080050_DailySL.aspx'+rqt;
                     }
                     else
                     {
                            url =System.RootURL + '/standard/reports/60/08/60080050_DailySL_CCY.aspx'+rqt;
                     }
                    System.OpenTargetPage( url , 'newform' );
                    return;
               }*/
    ...
    case "KOR":
               ...
               if (lstReportType.value=="S03a2-DN")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/standard/reports/60/08/60080050_SoNKchitienS03a2-DN.aspx'+rqt;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
                ...
                if (lstReportType.value=="S03a1-DN")
               {
                       ...
                       rqt = "?p_company_pk="+lstCompany.value+'&p_acc_pk='+txtAccPK.text+'&p_date_from='+dtbFrom.value+'&p_date_to='+dtbTo.value+'&p_ccy='+lstCurrency.value + '&p_status='+rdoSlipStatus.value+ '&bookccy='+lstBookCcy.value;  
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/standard/reports/60/08/60080050_SoNKthutienS03a1-DN.aspx'+rqt;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
                ...
                if (lstReportType.value=="S07-DN")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/standard/reports/60/08/60080050_Soquy_S07-DN.aspx'+rqt;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
               ...
               if (lstReportType.value=="S07a-DN")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/standard/reports/60/08/60080050_SoKToanCTquy_S07a-DN.aspx'+p;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
                ...
                if (lstReportType.value=="TGL")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/standard/reports/60/08/60080050_T_SOCAI.aspx'+rqt;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
                 ...
                 if (lstReportType.value=="S01-DN-DR")
               {
                    var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/standard/reports/60/08/60080050_TKDUPSN.aspx'+rqt;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                        }
                         else
                  ...
                  if (lstReportType.value=="S01-DN-CR")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/standard/reports/60/08/60080050_TKDUPSC.aspx'+rqt;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                        }
                         else
              ...
              //Tai khoan doi ung tong phat sinh no
                if (lstReportType.value=="TGL-DR")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/standard/reports/60/08/60080050_taikhoan_doiung_tongphatsinh_1.aspx'+rqt;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                          }
                         else
                ...
                if (lstReportType.value=="TGL-CR")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/standard/reports/60/08/60080050_taikhoan_doiung_tongphatsinh_2.aspx'+rqt;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
...
<body>
   <gw:data id="datSLSum" onreceive="OnDataReceive(this)" onerror="OnDataError(this)">
        <xml>
            <dso type="grid"  function="ac_sel_60190110_1">
                <input bind="grdSLSum">
   ...
   <gw:data id="datSLByDate" onreceive="OnDataReceive(this)" onerror="OnDataError(this)">
        <xml>
            <dso type="grid"  function="ac_sel_60190110">
      ...
      <gw:data id="datSLByVoucher" onreceive="OnDataReceive(this)" onerror="OnDataError(this)">
        <xml>
            <dso type="grid"  function="ac_sel_60190110_2">
