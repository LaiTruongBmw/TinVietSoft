...
public partial class rpt_60240010_Reservation : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        dt = CtlLib.TableReadOpenCursor("ht_rpt_60240010_reservation", para);
        //-----header---   
        ...
        if (dt.Rows.Count > 0)
        {
			...
			exSheet.Cells[10, 3].Value = dt.Rows[0]["addr1"].ToString();//partner
			exSheet.Cells[10, 3].Value = dt.Rows[0]["email_address"].ToString();//partner
			exSheet.Cells[10, 3].Value = dt.Rows[0]["phone_no"].ToString();//partner
