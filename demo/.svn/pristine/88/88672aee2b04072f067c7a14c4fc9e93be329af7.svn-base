...
using NativeExcel;
public partial class rpt_60280160_rvn_karaok_detail : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
       CtlLib.SetUser(Session["APP_DBUSER"].ToString());
        ...
        string TemplateFile = "rpt_60280160_rvn_karaok_detail.xls";
        string TempFile = "../../../../system/temp/rpt_60280160_rvn_karaok_detail_" + Session["User_ID"].ToString() + ".xls";
