        ...
        switch (obj.id) 
		{
            case 'data_epbp00101':
                if (grdDetail.rows > 1) 
				{
                    ...
                    grdDetail.SetCellBgColor(1, G_IN_QTY, grdDetail.rows - 1, G_IN_QTY, 0xCCFFFF);
                }
            break;
        }
    }
...
<body>
    ...
    <gw:data id="data_epbp00101" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid" user="sale"   function="st_lg_sel_epbp00101" > 
                <input> 
    ...
    <table style="width: 100%; height: 100%">
        ...
        <tr style="height: 100%">
            <td colspan="2">
                <gw:grid id='grdDetail' header='Date|Slip No|_TR_ITEM_PK|Item Code|Item Name|UOM|In Qty'
