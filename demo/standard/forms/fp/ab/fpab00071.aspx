...
<body>
    <!---------------------------------------------------------------->
    <gw:data id="data_fpab00071" onreceive="OnReceiveData(this)"> 
        <xml>                                                               
            <dso id="1" type="control" user="prod" function="st_lg_sel_fpab00071"  > 
                <inout> 
    ...
    <xml> 
           <dso id="1" type="grid" function="st_lg_sel_fpab00071_1" > 
                  <input bind="idGrid" >
