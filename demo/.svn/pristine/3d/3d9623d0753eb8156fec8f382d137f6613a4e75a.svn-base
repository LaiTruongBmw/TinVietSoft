...
<script>
 ...
 <%=CtlLib.RenderControlHTML("dso_60080330_PL","col_index") %>
...
function BodyInit()
{
   ...
   <%=CtlLib.RenderControlHTML("dso_60080330_PL","grid_list") %> 
...
function onNew()
{
	...
	//	else
		//{
		//	alert("Please,choose account code to add new.");
		//	return;
	//	}	
...
<%=CtlLib.RenderControlHTML("dso_60080330_PL","data") %>
        ...
        <tr style="width:100%; height:100%">
            <td width="100%" style="width:100%; height:100%">
                <gw:tab id="idTab_Child"  onpageactivate ="onSearch()"  >
                    ...
                    <table  name="PL" align="top" cellspacing=0 cellpadding=0 border=1 style="width:100%;height:100%;" >    
                        <tr valign="top">
                            <td width="100%">
                               <%=CtlLib.RenderControlHTML("dso_60080330_PL","grid") %> 
                            </td>
                        </tr>
                    </table>
                </gw:tab>                    
