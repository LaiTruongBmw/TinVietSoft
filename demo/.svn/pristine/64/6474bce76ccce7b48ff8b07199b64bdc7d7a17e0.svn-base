...
//=========================================================================
 ...
 {
	var path = System.RootURL + "/standard/forms/ho/24/60240030_allotment_popup.aspx?p_date=" + dtDate.GetData()+"&p_room_type="+txtType.text;
...
<body>
    ...
    <gw:data id="dsoDetail" onreceive="OnDataReceive(this)"> 
        <xml>
           <dso  type="grid"  function="ht_sel_60240030_popup1" >
