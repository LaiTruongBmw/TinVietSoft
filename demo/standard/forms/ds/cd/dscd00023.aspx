...
function OnReport()
{
    switch(radType.value)
    {
        ...
        break;
        case '1':
            var url =System.RootURL + '/standard/reports/ds/cd/rpt_dscd00020_DW.aspx?master_pk='+ l_master_pk  ;
             window.open(url); 
        break;
        case '2':
            var url =System.RootURL + '/standard/reports/ds/cd/rpt_dscd00020_DW_02.aspx?master_pk='+ l_master_pk  ;
	        window.open(url);   
        break;
        case '3':
            var url =System.RootURL + '/standard/reports/ds/cd/rpt_dscd00020_DW_03.aspx?master_pk='+ l_master_pk  ;
	         window.open(url); 
        break;
        case '4':
            var url =System.RootURL + '/standard/reports/ds/cd/rpt_dscd00020_DW_04.aspx?master_pk='+ l_master_pk  ;
	        window.open(url); 
        break;
    }   
    this.close(); 	
...
<body>    
 <!---------------------------------------------------------------->
    <gw:data id="pro_dscd00023" > 
        <xml> 
            <dso type="process" procedure="st_lg_pro_dscd00023" > 
                <input>      
