...
public partial class rpt_hrem01000_2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		string p_user,p_tco_org_pk,p_wg,p_emp_search,p_from_dt,p_to_dt,p_resign_type,p_contract_type,p_break_type,p_nation,p_lang ;
		
			p_user = Request["p_user"].ToString();
			p_tco_org_pk = Request["p_tco_org_pk"].ToString();
			p_emp_search = Request["p_input"].ToString();			
			p_from_dt = Request["p_from"].ToString();
			p_to_dt = Request["p_to"].ToString();
			p_resign_type = Request["p_type"].ToString();
			p_contract_type = Request["p_con_type"].ToString();
			p_break_type = Request["p_br_type"].ToString();
		...
		if(p_lang == "ENG")
		{
			TemplateFile = "rpt_hrem01000_2_eng.xls";
		}
        else
			TemplateFile = "rpt_hrem01000_2_vie.xls";
		
        string TempFile = "../../../../system/temp/rpt_hrem01000_2" + Session["User_ID"].ToString() + ".xls";
        ...
        string para = "'" + p_tco_org_pk + "','"+ p_emp_search + "','" + p_from_dt +
						"','" + p_to_dt + "','" + p_resign_type + "','" + p_contract_type +"','" + p_break_type
						+"','"+ p_nation + "','" +p_lang+"'";
		
		DataTable dt_emp = CtlLib.TableReadOpenCursor("ST_HR_RPT_HREM01000_2", para);
