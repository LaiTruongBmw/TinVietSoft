...
function OnReport()
{
	...
	{
		var url =System.RootURL + '/standard/reports/60/08/60080010_envn.aspx?seq='+txtseq.text;
...
{
	var path = System.RootURL + '/standard/forms/60/06/60060020_1.aspx?com_pk='+ lstCompany.GetData() + '&seq=' + txtseq.GetData() + '&status=' + txtStatus.GetData() + '&userid=' + txtProposedByUserID.GetData() + '&usernm=' + txtProposedByUserName.GetData() + '&userpk=' + txtProposedByUserPk.GetData() + '&dsqlid=AC_PRO_60060020_CONFIRM_CANCEL' + '&table=TAC_HGTRH';
...
<!------------------------------------------------------------------------------------------------------->
 ...
 <gw:data id="dso_udp_ctl_mst_slip_entry" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="control" function="AC_60060020_POPUP">
            <inout> 
                <inout bind="txtseq"/>
    ...
    <gw:data id="dso_sel_grd_dtl_slip_entry_dr" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" function="AC_SEL_60060020_POPUP_1">
                <input bind="grdDebit" >
                    <input bind="txtseq"/>
    ...
    <gw:data id="dso_sel_count_ctl_item" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="AC_PRO_60060020_POPUP" > 
                <input> 
                     <input bind="txtacpk"/>
                     <input bind="txt_drcr_type"/>
                     <input bind="txthgtrd"/>
    ...
    <gw:data id="dso_sel_control_new_item" onreceive="ItemStyle()">
        <xml>
            <dso type="grid" function="AC_SEL_60060020_2" >
    ...
    <gw:data id="dso_upd_approval_cancel" onreceive="SetButtonEnable()"> 
        <xml> 
            <dso type="process" procedure="AC_PRO_60060020_APPRO_CANCEL" > 
                <input> 
