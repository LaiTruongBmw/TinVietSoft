...
function OnPopUp(pos)
{
    switch(pos)
    {
         case 'POConfirm':
            if ( grdConfirm.row > 0 )
            {
                var path = System.RootURL + '/standard/forms/bi/as/bias00031.aspx?type=APPROVE&trans_pk=' + grdConfirm.GetGridData( grdConfirm.row, G1_TRANS_PK);
         ...
         case 'POApprove':
            if ( grdApprove.row > 0 )
            {
                    var path = System.RootURL + '/standard/forms/bi/as/bias00031.aspx?type=CANCEL&trans_pk=' + grdApprove.GetGridData( grdApprove.row, G2_TRANS_PK);
                    var object = System.OpenModal( path, 1000, 600, 'resizable:yes;status:yes', this);
...
<body>
    ...
    <gw:data id="data_bias00030" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid"  function="st_lg_SEL_bias00030"  >
    ...
    <gw:data id="data_bias00030_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="2" type="grid"  function="st_lg_SEL_bias00030_1"  >
                ...
                <table style="width: 100%; height: 100%">
                    <tr>
                        ...
                        <td style="width: 1%" align="right">
                            <gw:button img="excel" alt="Print Report" text="Report" styles='display:none' id="btnPrint" onclick="OnPrint()" />
                        </td>
                        <td style="width: 1%">
