...
<body>
<gw:data id="datDailyEmpAbs" onreceive="OnDataReceive()" > 
        <xml> 
            <dso  type="grid"  function="ST_HR_SEL_HREM00402_0"> 
                <input bind="grdEmployee" >
                    <input bind="txtUpperDept_PK" />
                    <input bind="txtDept_PK" />
                    <input bind="txtGrp_PK" />
                    <input bind="txtDate" />
                    <input bind="txtAbs_Type" />
		...
		<table width="100%" height=93% border=1 cellspacing=0 cellpadding=0 >		
			<tr>
				<td align = top height=100% >					
					<gw:grid   
                        id="grdEmployee"  
                        header="Department|Team/Section|Emp Id|Full Name|Join Date|Absence Type|Remark"
                        format="0|0|0|0|4|0|0"  
                        aligns="0|0|1|0|1|0|0"  
                        defaults="||||||"  
                        editcol="0|0|0|0|0|0|0"  
                        widths="1500|1500|1200|2700|1600|1500|1500"  
