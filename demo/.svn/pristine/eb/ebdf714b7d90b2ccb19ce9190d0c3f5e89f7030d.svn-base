...
function OnReport()
{
	...
	{
		/*var url = '/standard/reports/ho/25/rpt_602500230_Guest_Profile.aspx?p_guest_phone_mail='+ txtFullName.text+'&p_dtfrm='+dtFrom.value+'&p_dtto='+dtTo.value; 
	     System.OpenTargetPage( System.RootURL+url , "newform" );	*/ 
		 var url =System.RootURL + '/standard/reports/ho/25/rpt_602500230_Guest_Profile.aspx?p_guest_phone_mail='+txtFullName.text+'&p_dtfrm='+dtFrom.value+'&p_dtto='+dtTo.value;
