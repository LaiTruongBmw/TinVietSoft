...
<head id="Head1" runat="server">
    <title>Popup Visitor Checking</title>
</head>
<script>
...
function BodyInit() {
    ...
    <%=CtlLib.SetGridColumnComboFormat("idGrid", 4, "select code,CODE_NM from vhr_hr_code where id='HR0191' order by code")%>;
...
function OnDataReceive(obj) {
    if (obj.id == "datchrm00010_02_popup") {
        if (idGrid.rows > 1)
            //Set_Enable();
...
function OnClickBtn(obj)
{
    ...
    {
        case 'search':
            datchrm00010_02_popup.Call("SELECT");
            break;
...
<gw:data id="datchrm00010_02_popup" onreceive="OnDataReceive(this)" > 
        <xml> 
            <dso  type="grid" parameter="0,1,2,3,4,5,6" function="dorco2.sp_sel_chrm00010_02" procedure="dorco2.sp_upd_chrm00010_02"> 
                <input bind="idGrid" >
                    <input bind="dtFromDT" />
                    <input bind="dtToDT" />
                    <input bind="idSearch" />
	        ...
	        <table style="width:100%;height:12%" cellpadding="0" cellspacing="0" valign="top" border="0" >	
	            <tr style="height:6%;border:0">	
		            ...
		            <td align=left colspan=3 style="width:15%"><gw:list  id="idSearch" value="1" styles="width:98%" onChange="">
                                            <data>|1|Visitor Name</data></gw:list></td>
	        ...
	        <table id="tblMain" style="width:100%;height:88%" border=1 cellpadding="0" cellspacing="0">
	            <tr style="width:100%;height:100%">
	                <td id="tdMaster" style="width:100%">
	                    <gw:grid   
				        id="idGrid"  
				        header="_pk|Visitor Name|Work Date|Time In|Meal Times|Meal Qty|Remark"   
				        format="0|0|4|0|2|-0|0"  
				        aligns="0|0|0|1|0|0|0"  
				        defaults="|||||||"  
				        editcol="0|1|1|1|1|1|1"  
				        widths="0|3000|1500|1000|2000|1000|3000"  
