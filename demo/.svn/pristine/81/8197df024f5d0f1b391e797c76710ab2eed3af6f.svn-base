            ...
            {		    	
                case '1'://Sổ nhật ký chung(Mẫu số S03a-DN)(2)
                    if(confirm("Are you sure you want to print ?" ))
						{
							var url = '/standard/reports/gf/ka/gfka00160_SoNKC_S03a-DN.aspx?Company='+lstCompany.value+'&DateFrom=' +From1.value+ '&DateTo=' + To1.value+'&BookCcy='+lstBookCcy.value+'&status='+rbstatus.value;
				...
				case '2'://Sổ nhật ký thu tiền
					...
					if(confirm("Are you sure you want to print ?" ))
					{
						...
						var url = '/standard/reports/gf/ka/gfka00160_SoNKthutien_S03a1-DN.aspx?company_pk='+lstCompany.value+'&account_pk='+idAC_PK2.text+'&dtbFrom=' +From2.value+ '&dtbTo=' + To2.value+'&ccy=ALL&status='+rbstatus.value+'&bookccy='+lstBookCcy.value;
						System.OpenTargetPage( System.RootURL+url , "newform" );
					}
					break;
				case '3'://Sổ nhật ký chi tiền
					...
					if(confirm("Are you sure you want to print ?" ))
					{
						...
						var url = 
'/standard/reports/gf/ka/gfka00160_SoNKchitien_S03a2-DN.aspx?company_pk='+lstCompany.value+'&account_pk='+idAC_PK3.text+'&dtbFrom=' +From3.value+ '&dtbTo=' + To3.value+'&ccy=ALL&status='+rbstatus.value+'&bookccy='+lstBookCcy.value;
						System.OpenTargetPage( System.RootURL+url , "newform" );
					}
					break;
				...
				case '6'://Sổ cái (hình thức Nhật ký chung)
					...
					{
						var url = 
'/standard/reports/gf/ka/gfka00160_Socai-S03b-DN.aspx?company_pk='+lstCompany.value+'&account_pk='+idAC_PK6.text+'&dtbFrom=' +From6.value+ '&dtbTo=' + To6.value+'&ccy=ALL&status='+rbstatus.value+'&bookccy='+lstBookCcy.value;
						System.OpenTargetPage( System.RootURL+url , "newform" );
					}
					break;
				case '7'://Sổ quỹ tiền mặt
					...
					{
						var url = 
'/standard/reports/gf/ka/gfka00160_SoquyTM-S07-DN.aspx?company_pk='+lstCompany.value+'&account_pk='+idAC_PK7.text+'&dtbFrom=' +From7.value+ '&dtbTo=' + To7.value+'&ccy=ALL&status='+rbstatus.value+'&bookccy='+lstBookCcy.value;
						System.OpenTargetPage( System.RootURL+url , "newform" );
					}
					break;
				case '8'://Sổ kế toán chi tiết quỹ tiền mặt
					...
					{
						var url = 
'/standard/reports/gf/ka/gfka00160_SoKToanCTquyTM-S07a-DN.aspx?company_pk='+lstCompany.value+'&account_pk='+idAC_PK8.text+'&dtbFrom=' +From8.value+ '&dtbTo=' + To8.value+'&ccy=ALL&status='+rbstatus.value+'&bookccy='+lstBookCcy.value;
						System.OpenTargetPage( System.RootURL+url , "newform" );
					}
					break;
				case '9'://Sổ tiền gởi ngân hàng
					...
					{
						var url = 
'/standard/reports/gf/ka/gfka00160_SotienguiNH_S08DN2.aspx?company_pk='+lstCompany.value+'&bank_pk='+bankpk+'&dtbFrom=' +From9.value+ '&dtbTo=' + To9.value+'&ccy=ALL&status='+rbstatus.value+'&bookccy='+lstBookCcy.value+'&account_pk='+idAC_PK9.text;
						System.OpenTargetPage( System.RootURL+url , "newform" );
					}
					else
					{
						var url = 
'/standard/reports/gf/ka/gfka00160_SotienguiNH_S08DN.aspx?company_pk='+lstCompany.value+'&bank_pk='+bankpk+'&dtbFrom=' +From9.value+ '&dtbTo=' + To9.value+'&ccy=ALL&status='+rbstatus.value+'&bookccy='+lstBookCcy.value+'&account_pk='+idAC_PK9.text;
						System.OpenTargetPage( System.RootURL+url , "newform" );
					}
					break;
					...
					if(confirm("Are you sure you want to print ?" ))
					{
					    ...
					    {
						        url = '/standard/reports/gf/ka/gfka00160_SoChitietTK_S38-DN.aspx?company_pk='+lstCompany.value+'&account_pk='+idAC_PK11.text+'&dtbFrom=' +From11.value+ '&dtbTo=' + To11.value+'&ccy=ALL&status='+rbstatus.value+'&bookccy='+lstBookCcy.value;
						}
						else
						{
						        url = '/standard/reports/gf/ka/gfka00160_SoChitietTK_S38-DN2.aspx?company_pk='+lstCompany.value+'&account_pk='+idAC_PK11.text+'&dtbFrom=' +From11.value+ '&dtbTo=' + To11.value+'&ccy=ALL&status='+rbstatus.value+'&bookccy='+lstBookCcy.value+'&transccy='+lstCurrency11.value;
						}        
						System.OpenTargetPage( System.RootURL+url , "newform" );
					}
					break;
