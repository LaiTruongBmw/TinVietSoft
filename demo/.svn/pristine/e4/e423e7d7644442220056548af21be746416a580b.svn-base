...
<script>
 ...
 function OnReport()
 {
    /*var url = '/standard/reports/ht/fo/htfo00020.aspx?p_dt_frm='+ dtFrom.value+'&p_dt_departure='+dtTo.value;
	...
	var url = '/standard/reports/60/25/rpt_htfo00020_departure.aspx?p_dt_frm='+ dtFrom.value+'&p_dt_departure='+dtTo.value;
			System.OpenTargetPage( System.RootURL+url , "newform" );  
...
<body>
    ...
    <gw:data id="data_htfo00020" onreceive="OnDataReceive(this)"> 
        <xml>
           <dso  type="grid"  function="st_ht_sel_60250040" >
