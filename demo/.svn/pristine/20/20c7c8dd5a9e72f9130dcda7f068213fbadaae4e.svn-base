...
<body>
    ...
    <gw:data id="data_dsos00020" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid" user="sale"   parameter="0,1,2,3" function="st_lg_sel_dsos00020" > 
                <input> 
                    <input bind="dtFrom" /> 
                    <input bind="dtTo" /> 
    ...
    <gw:data id="data_dsos00020_2" onreceive="OnDataReceive(this)"> 
        <xml> 
           <dso id="1" type="grid" function="st_lg_sel_dsos00020_2" > 
                  <input > 
    ...
    <gw:data id="pro_dsos00020" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="st_lg_pro_dsos00020" > 
                <input>
    ...
    <gw:data id="pro_dsos00020_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="st_lg_pro_dsos00020_1" > 
                <input>
                     <input bind="txtOrderListPK" /> 
                </input> 
                <output> 
    ...
    <gw:data id="pro_dsos00020_2" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="st_lg_pro_dsos00020_2" > 
                <input>
                     <input bind="txtOrderListPK" /> 
                </input> 
                <output> 
    ...
    <gw:data id="pro_dsos00020_3" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="st_lg_pro_dsos00020_3" > 
                <input>
                     <input bind="txtOrderListPK" /> 
                </input> 
                <output> 
                        ...
                        <td colspan="5">
                            <table style="width: 100%; height: 100%; background-color: #B4E7FF">
                                <tr style="height: 1%">
                                    ...
                                    <td style="width: 1%; white-space: nowrap">
                                        <gw:button id="idBtnTOReq" img="Make T/O Req" text="Make T/O Req" onclick="OnProcess('TOReq')" />
                                    </td>
                                    <td style="width: 1%">
                                        <gw:button id="idBtnMR" img="Make M/R" text="Make M/R" onclick="OnProcess('MR')" />
                                    </td>
                                    <td style="width: 1%">
                                        <gw:button id="idBtnCancelMR" img="Cancel M/R" text="Cancel M/R" onclick="OnProcess('Cancel_MR')" />
                                    </td>
                                </tr>
                            </table>
                        </td>
