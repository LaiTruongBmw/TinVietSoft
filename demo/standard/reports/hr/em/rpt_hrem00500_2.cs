...
public partial class rpt_hrem00500_2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string p_tco_org_pk,p_emp_search,p_probation_type,p_contract_type,p_select_date,p_from_date,p_to_date,p_status,p_lang;
		...
		if(p_lang == "ENG")
		{
			TemplateFile = "rpt_hrem00500_2_eng.xls";
		}
        else
			TemplateFile = "rpt_hrem00500_2_vie.xls";
		
        string TempFile = "../../../../system/temp/rpt_hrem00500_2_" + Session["User_ID"].ToString() + ".xls";
        ...
        string para = "'" + p_emp_search + "','" + p_select_date + "','" + p_from_date + "','"+ p_to_date  + "','" + p_tco_org_pk + "','" + p_probation_type + "','"+ p_contract_type + "','"+ p_status +"','"+ p_lang +"'";
		
		DataTable dt_emp = CtlLib.TableReadOpenCursor("ST_HR_RPT_HREM00500_2", para);
