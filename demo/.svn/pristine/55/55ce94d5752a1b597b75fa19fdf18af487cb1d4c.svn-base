...
function OnReport(obj)
 {
	 ...
	 if(obj=='2')
	{
		 if(grdMinibarReport.rows > 1)
		 {
			var url = '/standard/reports/ho/28/rpt_60280160_rvn_karaok_detail.aspx?p_dtfrom='+dtFromDate.GetData()+"&p_dtto="+dtToDate.GetData(); 
...
<body>
    ...
    <xml> 
        <dso  type="grid" function="ht_sel_60280160"> 
