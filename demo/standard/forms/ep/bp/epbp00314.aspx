...
<head id="Head1" runat="server">
    <title>P/R CHECKING : OUTGO DETAIL</title>
</head>
<%  
...
<body>
    <!----------------------------------------------------------------------->
    <gw:data id="data_epbp00314" onreceive="OnDataReceive(this)">	
		<xml>	
			<dso	id="2"	type="grid"	parameter="0,1,2,3"	function="st_lg_SEL_epbp00314"	>	
				<input>
        ...
        <tr style="height: 99%">
            <td colspan="10">
                <gw:grid id='grdDetail' 
					header='Slip No|Tr Date|_PK|Seq|Ref No|Item Code|Item Name|UOM|Req Qty|Out Qty|Remark'
