...
function BodyInit()
{
	...
	var ls_balance_type     = "<%=CtlLib.SetListDataFUNC("SELECT AC_GET_COMMONCODE('EACBK056') FROM DUAL")%>";
	var ls_Half_year     = "<%=CtlLib.SetListDataFUNC("SELECT AC_GET_COMMONCODE('EACBK057') FROM DUAL")%>";
	...
	rdoType.SetDataText(ls_balance_type);
	lstHalf_year.SetDataText(ls_Half_year);
...
function OnChangeDateType(){
    ...
    if(idTab_Child.GetCurrentPageNo() == 0){
        if(rdoType.GetData() == 1){
			...
			lstHalf_year.style.display = "none";
        }
		...
		else if(rdoType.GetData() == 6){
            txtDateType.text = "H";
            lblDateType.text = "";
            dtMonth.style.display = "none";
            dtYear.style.display = "";
            lstQuater.style.display = "none";
			lstHalf_year.style.display = "";
        }
      }
        ...
        if(rdoType.GetData() == 1){
           ...
           // obj.ColHidden(12) = true;
            ...
            lstQuater.style.display = "none";
			lstHalf_year.style.display = "";
			if(lstHalf_year.value=='1')
			{
				grid_ic.SetGridText(0,9,"First half year of " + yyyy);//this period        
				grid_ic.SetGridText(0,10,"First half year of " + (yyyy-1));//this period of previous year
				grid_ic.SetGridText(0,11,"Acc of first half year of " + yyyy);//accumulate from beginning of year to this period
				grid_ic.SetGridText(0,12,"Acc of first half year of " + (yyyy-1));//accumulate from beginning of previous year to this period - 1 year
            }
			else
			{
				grid_ic.SetGridText(0,9,"Second half year of " + yyyy);//this period        
				grid_ic.SetGridText(0,10,"Second half year of " + (yyyy-1));//this period of previous year
				grid_ic.SetGridText(0,11,"Acc of second half year of " + yyyy);//accumulate from beginning of year to this period
				grid_ic.SetGridText(0,12,"Acc of second half year of " + (yyyy-1));//accumulate from beginning of previous year to this period - 1 year
			}
        }
...
function CalculateFTDate(){
	...
	else if(rdoType.GetData() == 6)//half year
	{
        yyyy = dtYear.GetData();
        half = lstHalf_year.GetData();
        if(half == 1){
            dtfrdate.SetDataText(yyyy + "0101");    
            dttodate.SetDataText(yyyy + "0630");    
        }
...
function onReport(lang)
{
    ...
    switch(lang)
    {
        case "VIE":
             ...
             r= r + '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData()+'&p_lang='+lstLang.value+'&p_circulars='+lstCirculars.value;
            ...
            switch(x)
            {
                case "21": // balance sheet
                    ...
                    {
                       case "1"://Monthly
                              var url = '/standard/reports/gf/ka/gfka00080_BS_VIE.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() + "&p_Scale="+txtScale.GetData()+'&p_circulars='+lstCirculars.value;
                ...
                case "22": // Income statement
                    switch(rdoType.value)
                    {
                        ...
                        case "2"://Quarter
							...
							//f_nm='rpt_60080170_IC_QUARTER_VIE.aspx';  
							var url='/standard/reports/gf/ka/'+f_nm+r; 
							 System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "3"://Year
                ...
                case 21: // balance sheet
                  r='?p_kind='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData();
                    ...
                    switch(rdoType.value)
                    {
                        ...
                        case "1"://Monthly
                              var url = '/standard/reports/gf/ka/gfka00080_BS_ENG.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData()+ "&p_Scale="+txtScale.GetData()+'&p_circulars='+lstCirculars.value;
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                            var url = '/standard/reports/gf/ka/gfka00080_BS_ENG.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData()+ "&p_Scale="+txtScale.GetData()+'&p_circulars='+lstCirculars.value; 
				 ...
				 switch(rdoType.value)
                    {
                        ...
                        case "2"://Quarter
							...
							//f_nm='rpt_60080170_IC_QUARTER_ENG.aspx';
							var url='/standard/reports/gf/ka/'+f_nm+r; 
							System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "3"://Year
        ...
        break;
         case "KOR":
            r='?p_kind='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData();
            r= r + '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData()+'&p_circulars='+lstCirculars.value;
            r=r+"&p_quarter="+lstQuater.GetData(); 
            var x=txtFinancialType.GetData();
             x=Number(x);
            switch(x)
            {
                case 21: // balance sheet
                    ...
                    {
                        case "1"://Monthly
                              var url = '/standard/reports/gf/ka/gfka00080_BS_KOR.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData()+'&p_circulars='+lstCirculars.value; 
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                            var url = '/standard/reports/gf/ka/gfka00080_BS_KOR.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData()+"&p_Scale="+txtScale.GetData()+'&p_circulars='+lstCirculars.value; 
...
p= p + '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();  
            p=p+"&p_quarter="+lstQuater.GetData()+'&p_lang='+lstLang.value+'&p_circulars='+lstCirculars.value; 
                            f_nm='/standard/reports/gf/ka/gfka00080_IC_QUARTER_KOR.aspx'+p;  
							//f_nm='/standard/reports/60/08/rpt_60080170_IC_QUARTER_KOR.aspx'+p;
                             System.OpenTargetPage( System.RootURL+f_nm , "newform" );
                        break;
                        case "3"://Year
        ...
        case "ENG-VIE":
            ...
            switch(x)
            {
                case 21:
                    ...
                    {
                        case "1"://Monthly
                             var url = '/standard/reports/gf/ka/gfka00080_BS_ENG_VIE.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData()+'&p_circulars='+lstCirculars.value;
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                           var url = '/standard/reports/gf/ka/gfka00080_BS_ENG_VIE.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData()+'&p_circulars='+lstCirculars.value;
				 ...
				 switch(rdoType.value)
                    {
                        ...
                        case "2"://Quarter
							...
							//f_nm='rpt_60080170_IC_QUARTER_ENG_VIE.aspx';
							var url='/standard/reports/gf/ka/'+f_nm+r; 
							System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "3"://Year
        ...
        case "KOR-VIE":
            ...
            switch(x)
            {
                case 21:
                    ...
                    {
                        case "1"://Monthly
                             var url = '/standard/reports/gf/ka/gfka00080_BS_KOR_VIE.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData()+'&p_circulars='+lstCirculars.value;
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                            var url = '/standard/reports/gf/ka/gfka00080_BS_KOR_VIE.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData()+'&p_circulars='+lstCirculars.value;
				 ...
				 switch(rdoType.value)
                    {
                        ...
                        case "2"://Quarter
							...
							//f_nm='rpt_60080170_IC_QUARTER_KOR_VIE.aspx';
							var url='/standard/reports/gf/ka/'+f_nm+r; 
							System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "3"://Year
        ...
        case "ENG-VIE-KOR":
            ...
            switch(x)
            {
                case 21:
                    ...
                    {
                        case "1"://Monthly
                             var url = '/standard/reports/gf/ka/gfka00080_BS_ENG_VIE_KOR.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData()+'&p_circulars='+lstCirculars.value;
							System.OpenTargetPage( System.RootURL+url , "newform" );
						break;
                        case "2"://Quarter
                           var url = '/standard/reports/gf/ka/gfka00080_BS_ENG_VIE_KOR.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData()+'&p_circulars='+lstCirculars.value;
				 ...
				 switch(rdoType.value)
                    {
                        ...
                        case "2"://Quarter
							...
							//f_nm='rpt_60080170_IC_QUARTER_ENG_VIE_KOR.aspx';
							var url='/standard/reports/gf/ka/'+f_nm+r; 
							System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "3"://Year
        ...
        case "ENG-KOR":
            ...
            switch(x)
            {
                case 21:
                    ...
                    {
                        case "1"://Monthly
                             var url = '/standard/reports/gf/ka/gfka00080_BS_ENG_KOR.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData()+'&p_circulars='+lstCirculars.value;
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                           var url = '/standard/reports/gf/ka/gfka00080_BS_ENG_KOR.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData()+'&p_circulars='+lstCirculars.value;
				 ...
				 switch(rdoType.value)
                    {
                        ...
                        case "2"://Quarter
							...
							//f_nm='rpt_60080170_IC_QUARTER_ENG_KOR.aspx';
							var url='/standard/reports/gf/ka/'+f_nm+r; 
							System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "3"://Year
...
<!------------------------------------------------------------------------>
 <gw:data id="dso_getCompany" onreceive=""> 
    ...
    <gw:data id="dso_sel_grd_balance_sheet" onreceive="onSetFont(this)">
        <xml>
            <dso type="grid" function="ac_sel_60080240_balance_sheet">
                <input bind="grid_bs">
                    <input bind="lstCompany"/>
					<input bind="dtfrdate" />
                    <input bind="dttodate"/>
    ...
    <gw:data id="dso_sel_grd_income" onreceive="onSetFont(this)">
        <xml>
            <dso type="grid" function="ac_sel_60080240_income">
                <input bind="grid_ic">
    ...
    <gw:data id="dso_gfka00080_2" onreceive="onSetFont(this)">
        <xml>
            <dso type="grid" function="ac_sel_60080240_2">
...
<body>
	<table style='width:100%;height:100%' cellpadding="2" cellspacing="2" >
		<tr height='2%'>
			...
			<td width="20%"><gw:list id="lstCompany" onchange="" styles='width:100%' /></td>
			<td width="10%" align='right'>Balance</td>
			<td width="15%"><gw:list id="rdoType" styles="width:100%;" onchange="OnChangeDateType()" /> </td>
			<td width="10%" align='right'><gw:label id="lblDateType" text="Month:" styles="width:100%;font-weight:600;" /></td>
			<td width="10%"><gw:list id="lstQuater" styles="width:100%;" onchange="OnChangeQuater()" ><data>Data|1|I|2|II|3|III|4|IV</data></gw:list>
							<gw:list id="lstHalf_year" styles="width:100%;" onchange="OnChangeQuater()" /></td>
			<td width=""   ><gw:datebox id="dtYear" type="year" lang="1" styles="display:none" onchange="OnChangeYear()"/>
							<gw:datebox id="dtMonth" type="month" lang="1" onchange="OnChangeMonth()"/></td>
			<td width='25%'>
				<table style='width:100%' cellpadding="0" cellspacing="0" >
					<tr>
						<td width=""><gw:datebox id="dtfrdate" type="date" lang="1" /></td>
						<td>~</td>
						<td width=""><gw:datebox id="dttodate" type="date" lang="1" /></td>
						<td width="100%"></td>
					</tr>
				</table>
			</td>
		...
		<tr height='2%'>
			...
			<td><gw:radio id="rbstatus" value="2" onchange="onSearch()"><span value="2">Confirmed</span><span value="0">Approved</span></gw:radio></td>
			...
			<td>
				<table style='width:100%' cellpadding="0" cellspacing="0" >
					<tr>
						...
						<td width='40%'><gw:textbox id="txtrate1" text="1" styles='width:100%' type="number" format="###,###.##R" onenterkey="onSearch()" /></td>
						<td style='white-space:nowrap'>Unit</td>
						<td width='20%'><gw:textbox id="txtScale" styles='width:100%' type="number" format="###,###,###R" onenterkey="onSearch()" /></td>
						<td style='white-space:nowrap'><gw:label id="lblBookccy" styles="width:100%;color:red; font-weight:700;" /></td>
					</tr>
				</table>
			</td>
			<td width=""><gw:imgbtn id="ibtnReport" img="excel" alt="Print" onclick="onReport(lstLang.GetData())" /></td>
		</tr>
		<tr>
			<td align='right' colspan='7'>Circulars</td>
			<td><gw:list id="lstCirculars" onchange="" styles='width:100%' /></td>
		</tr>
		<tr height='96%'>
			<td colspan='12'>
				<gw:tab id="idTab_Child" onpageactivate="onSetDataList()">
				<table name="Balance Sheet"  align ="top"  cellspacing=0 cellpadding=0 border=0 style="width:100%;height:100%;" >
				...
				<table name="Income Statement"  align ="top"  cellspacing=0 cellpadding=0 border=0 style="width:100%;height:100%;" >    
					<tr valign="top" height='100%'>
				...
				<table name="Cash Flows Direct"  align ="top"  cellspacing=0 cellpadding=0 border=0 style="width:100%;height:100%;" >    
					<tr valign="top" height='100%'>
