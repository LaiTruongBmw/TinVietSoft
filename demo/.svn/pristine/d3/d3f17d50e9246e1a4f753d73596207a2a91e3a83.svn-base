...
<body>
    <gw:data id="data_bico00021" onreceive="OnDataReceive(this)">	
		<xml>									
			<dso id="3"	type="grid"	parameter="0,1,2,3,4" function="st_lg_sel_bico00021" procedure="st_lg_upd_bico00021">	
				<input	bind="grdWH">					
				</input>
				<output	bind="grdWH"/>	
			</dso>	
    ...
    <gw:data id="data_bico00021_1" onreceive="OnDataReceive(this)">	
		<xml>									
			<dso id="3" type="control" parameter="0,1,2,3,4,5" function="st_lg_sel_bico00021_1" procedure="st_lg_upd_bico00021_1">	
				<inout>	
