...
<script>
 ...
 function OnReport(pos)
 {
	...
	{
		case 'SALE_SUM':
			var url = System.RootURL + '/standard/reports/ep/bp/rpt_epbp00171.aspx?p_f_out_type='+ dtFMonTab2.value +'&p_t_out_type='+dtTMonTab2.value +'&p_partner=' + txtSupplierTab2.text ;
		   
           System.OpenTargetPage(url); 		
		break;
		
		case 'DEBIT':
			var url = System.RootURL + '/standard/reports/ep/bp/rpt_epbp00170.aspx?p_partner_pk='+ txtPartnerPK.text 
...
<body>
    ...
    <gw:data id="data_epbp00170_2" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="st_lg_sel_epbp00170_2" > 
    ...
    <gw:data id="data_epbp00170_3" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="st_lg_sel_epbp00170_3" > 
    ...
    <gw:data id="data_epbp00170" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="st_lg_sel_epbp00170" > 
    ...
    <gw:data id="data_epbp00170_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="st_lg_sel_epbp00170_1" > 
    ...
    <gw:data id="pro_epbp00170" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="st_lg_pro_epbp00170" > 
                <input>
                     <input bind="txtPartnerPK" /> 
					 <input bind="dtYearTab1" />
					 <input bind="lstMonthTab1" />
            ...
            <td style="width: 70%" id='right'>
                <table style="width: 100%; height: 100%" border="0">
                    <tr style="height: 1%"> 
						...
						<td style="width: 9%">
							<gw:button id="idBtnPayment" img="Payment Req" text="Payment Req" onclick="OnProcess('PAYMENT_REQ')" />
						</td>
						...
						<td>
							<table style="width: 100%; height: 100%">
								<tr>	
									...
									<td style="width: 1%">
			                            <gw:button id="ibtnExcel3" img="excel" alt="Report" text="Report" onclick="OnReport('AP_BAL')" />
			                        </td>								
								</tr>
							</table>
						</td>                       
