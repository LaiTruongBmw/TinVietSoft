...
function OnReport(obj)
 {
	 ...
	 if(obj=="1")
	 {
		 ...
		 {
			var url = '/standard/reports/60/28/rpt_60280100.aspx?p_from='+dtFromDate.GetData()+"&p_to="+dtToDate.GetData() + "&p_invoice=" + txtInvoiceNo.GetData() + "&p_roomno="  + txtRoomNo.GetData() + "&p_loc=POINT-06&p_pay=" + lstPayment.GetData(); 
			System.OpenTargetPage( System.RootURL+url , "newform" );
		 }
	 }
	 else
	 {
			var url = '/standard/reports/60/28/rpt_6028010_revenue_item.aspx?p_from='+dtFromDate.GetData()+"&p_to="+dtToDate.GetData(); 
			System.OpenTargetPage( System.RootURL+url , "newform" );
	 }
 }
...
<body>
    ...
    <xml> 
        <dso  type="grid" function="st_ht_sel_60280100"> 
                                        ...
                                        <fieldset style="padding: 2; width: 100%; height: 100%">
                                            <table border="0" width="100%" id="table2">
                                                <tr>
                                                    ...
                                                    <td width="3%">
                                                         <gw:imgbtn id="ibtnReport" img="printer" alt="Print" onclick="OnReport(1)" styles='width:100%' />
                                                    </td>
													<td style="width: 3%" align="right"><gw:imgbtn id="btnReport" img="excel" alt="Print" text="Print" onclick="OnReport(2)" /></td>
                                                </tr>
                                            </table>
                                        </fieldset>
                                    </td>
