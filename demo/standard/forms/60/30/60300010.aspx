...
{ 	
    if (v_language!="ENG"){
		...
		txtExRate.text = "<%=CtlLib.SetDataSQL("SELECT to_char(sf_get_current_sell_ex_rate("+ Session("COMPANY_PK") +",'USD'),'999,999,999') from dual")%> VND";
    ...
    switch (obj.id)
    {
        case "datDeptData":
        {
		    ...
		    case "datFind_Report":
		    {
                ...
                {
                    //var url=System.RootURL+ '/standard/reports/ch/ae/' + txtReport_tmp.text + '?l_tco_dept_pk=' + lstDept_Code_1.value + '&l_dept_nm=' + lstDept_Code_1.GetText() + '&l_thr_group_pk=' + lstGrp_Code_1.value + '&l_status=' + lstStatus_1.value + '&l_emp_id=' + txtEmp_ID_1.text + '&l_work_mon=' + dtMonth.value ;
		        }
		        window.open(url);
		    }   
		    break;
			...
			if(arrOp[idx].checked)
				switch(arrOp[idx].id){   
					case "opArrivalList"://arrival
						var url = '/standard/reports/60/30/rpt_60300010.aspx?p_dt_frm='+ dtArrivalListFrom.value+'&p_dt_departure='+dtArrivalListTo.value+'&p_guest_name='+""+'&p_count_RM='+""+'&p_report_type='+"1";
					...
					case "opDepartureList"://Departure
						 var url = '/standard/reports/60/30/rpt_60300020_departure.aspx?p_dt_frm='+ dtDeparturelListFrom.value+'&p_dt_departure='+dtDepartureTo.value;
						System.OpenTargetPage( System.RootURL+url , "newform" );  
					break;	
					case "opInhouseList"://inhouse list		 
						 ...
						 //System.OpenTargetPage(url); 
						 var url = '/standard/reports/60/30/rpt_60300020_inhouse_list2.aspx?p_room='+ ''+'&p_report_type='+'1';
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break;	
					
					case "opOutOfOrder"://Out Of Order	 
						var url = '/standard/reports/60/30/rpt_60300010_ooo.aspx?p_no_parameter='+'';
						System.OpenTargetPage( System.RootURL+url , "newform" ); 
					break;	
					...
					case "opRevenueDaily"://night audit vnd
						var url = '/standard/reports/ja/ma/rpt_jama00150_Nigh_Audit_daily_VND.aspx?p_date='+dtRevenueDaily.value+'&p_ex_rate='+txtExRate.text;  //txtExRate.text
							System.OpenTargetPage( System.RootURL+url , "newform" );
					...
					case "opRevenueDaily_usd"://opRevenueDaily_usd    
						...
						{*/
							var url = '/standard/reports/60/30/rpt_60300010_Nigh_Audit_daily_USD.aspx?p_date='+dtRevenueDaily_usd.value+'&p_ex_rate='+txtExRate.text;  //txtExRate.text;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
						/*}
						else
						{
					...
					case "opRevenueDaily_usd2"://opRevenueDaily_usd    
						/*if(chkNightAuditUSD.value =='Y')
						{*/
							var url = '/standard/reports/60/30/rpt_60300010_Nigh_Audit_daily_USD.aspx?p_date='+dtRevenueDaily_usd2.value;  //txtExRate.text;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
						/*}
						else
						{
					...
					break;	
					case "opfnbdaily":
						url = '/standard/reports/ja/ma/jama00150_Daily_FnB_Golf_Revenue.aspx?p_date='+ dtNackBarAcademy.value;
						System.OpenTargetPage( System.RootURL+url , "newform" );
					break;
					case "opfinalrevenue":
							var url = '/standard/reports/ja/ma/rpt_jama00010_monthly_revenue_a3.aspx?p_month='+dtMonth.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
					...
					case "opfinalrevenueusd"://usd 
							var url = '/standard/reports/ja/ma/rpt_jama00010_monthly_revenue_usd_lotus.aspx?p_month='+dtMonthUSD.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );	
					break; 
					...
					case "opMarshallDepartmentMonthly":
						var url = '/standard/reports/ja/st/rpt_jast00100.aspx?p_month='+dtMarshallDepartmentMonthly.GetData();  
						System.OpenTargetPage( System.RootURL+url , "newform" );
					break; 		
					case "opWeeklyRevenue":
						
						var url = '/standard/reports/60/30/rpt_60300010_WeeklyRevenue.aspx?p_Month='+dtWeeklyRevenue.GetData()+'&p_week='+lstWeekly.value;  
						System.OpenTargetPage( System.RootURL+url , "newform" );
					break; 	
					case "opRoomFeeAdjust"://room fee adjust                                   
						  var url = '/standard/reports/60/30/rpt_60300010_fee_adjust_date_frm_to.aspx?p_dt_from='+dtRoomFeeAdjustFrm.value+ "&p_dt_to="+dtRoomFeeAdjustTo.value;
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break;	 
					case "opOtherFeeList"://other fee list                                     
						  var url = '/standard/reports/60/30/rpt_60300010_other_fee.aspx?p_dtfrom='+dtOtherFeeListFrm.value+ "&p_dtto="+dtOtherFeeListTo.value+ "&p_room_last_first_name="+''+ "&p_fee_type="+'ALL';
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break;	 
					...
					case "opFnBRevenuve"://FnB Revenuve
						  url = '/standard/reports/60/30/rpt_60300010_Revenue.aspx?p_fr=' + dtFnBRevenuveFrm.GetData() + '&p_to=' + dtFnBRevenuveTo.GetData() + '&p_loc=0&p_pay=0';
						  System.OpenTargetPage( System.RootURL+url , "newform" );
					break;	
					
					case "opFnBSession"://FnB Session    	                                     
						  url = '/standard/reports/60/30/rpt_60300010_Session.aspx?p_fr=' +dtFnBSessionFrm.value+'&p_to='+dtFnBSessionTo.value;
						  System.OpenTargetPage( System.RootURL+url , "newform" );
					break;	
					case "opFnB_PL_Monthly"://sql chi get dc dong 0-->11
						var url = '/standard/reports/ja/ma/rpt_jama00150_FnB_PL.aspx?p_month='+dtFnB_PL.GetData();  
						System.OpenTargetPage( System.RootURL+url , "newform" );
					break; 
					case "opdtMonthlyUSD_SR"://village monthly-->usd    
							var url = '/standard/reports/ja/ma/rpt_jama00010_Monthly_Revenue_SR_USD.aspx?p_month='+dtMonthUSD_SR.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break; 	
					case "opRoomRevenueYearly"://Room Revenue Yearly   
							var url = '/standard/reports/ja/ma/rpt_Room_Revenue_Yearly.aspx?p_year='+dtYear.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break; 
					case "opFnbRevenueYearly"://Fnb Revenue Yearly   
							var url = '/standard/reports/ja/ma/rpt_FnB_Revenue_Yearly.aspx?p_year='+dtYearFnB.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break; 
					case "opGolfRevenueYearly"://golf Revenue Yearly   
							var url = '/standard/reports/ja/ma/rpt_Golf_Revenue_Yearly.aspx?p_year='+dtYearGolf.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break; 
					case "opProshopDvrRangeYearly"://Proshop Drv range Revenue Yearly   
							var url = '/standard/reports/ja/ma/rpt_Proshop_drv_range_Revenue_Yearly.aspx?p_year='+dtYearProshopDvrRange.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break; 
					case "opfinalrevenueusd_not_tax"://revenue monthly usd not tax   
							//alert("Not..Yet");
							var url = '/standard/reports/ja/ma/rpt_jama00010_monthly_revenue_usd_nottax.aspx?p_month='+dtMonthUSDNotTax.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
						
					break; 
					case "opfinalrevenueVND_not_tax"://revenue monthly vnd not tax   
							//alert("Not..Yet");
							var url = '/standard/reports/ja/ma/rpt_jama00010_monthly_revenue_vnd_nottax.aspx?p_month='+dtMonthVNDNotTax.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
						
					break; 
					case "opMarketSegmentation"://Market Segmentation Yearly   
							var url = '/standard/reports/ja/ma/rpt_jama00150_MarketSegmentation.aspx?p_year='+dtYearMarketSegmentation.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break; 
					case "opfnb_sesion_yearly"://sesion_yearly     
							var url = '/standard/reports/ja/ma/rpt_jama000150_fnb_sesion_yearly.aspx?p_year='+dtYearfnbSesionYearly.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break;
					case "opRevenueSummary"://Revenue Summary
						 var url = '/standard/reports/ja/ma/rpt_jama00150_revenue_summary.aspx?p_dtfrm='+ dtFromRevenueSummary.value+'&p_dtto='+dtToRevenueSummary.value;
						System.OpenTargetPage( System.RootURL+url , "newform" );  
					break;		  	
					case "opMonthAnalyzeMemberDaily"://Month Analyze MemberDaily 
							var url = '/standard/reports/ja/ma/rpt_jama00150_analyze_member_daily.aspx?p_month='+dtMonthAnalyzeMemberDaily.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break; 	
					case "opYearAnalyzeMember"://Year Analyze Member  
							var url = '/standard/reports/ja/ma/rpt_jama00150_analyze_member_year.aspx?p_year='+dtYearAnalyzeMember.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break;
					case "opGolfRevenueMonthly"://Golf Revenue Monthly		
							var url = '/standard/reports/ja/ma/rpt_jama00150_Golf_Revenue_Monthly.aspx?p_month='+dtGolfRevenueMonthly.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break; 
					case "opGuest_statistic_By_Hour"://Month Guest_statistic_By_Hour  
							var url = '/standard/reports/ja/ma/rpt_jama00150_Guest_statistic_By_Hour.aspx?p_month='+dtGuest_statistic_By_Hour.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break; 
					case "opGolfTourFees"://golf tour fees    	                                     
						  url = System.RootURL + '/standard/reports/ja/ma/rpt_jama00150_golf_tour_fees.aspx?p_dt_from='+dtfrmGolfTourFees.value+'&p_dt_to='+dtToGolfTourFees.value;
							System.OpenTargetPage(url); 
					break;	
					case "opForcecast"://opForcecast    
							var url = '/standard/reports/ja/ma/rpt_jama00150_forcecast.aspx?p_date='+dtForcecast.value;  //txtExRate.text;  
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break;	
					case "opCashDailySummary"://opCashDailySummary 
						var url = '/standard/reports/60/30/rpt_60300010_cash_daily_summary2.aspx?p_date='+dtCashDailySummaryFrm.value+'&p_date_to='+dtCashDailySummaryTo.value+'&p_room='+''+'&p_payment_method='+'ALL'+'&p_partner_PK='+'' +"&p_time_frm=" +''+"&p_time_to=" +''+"&p_cashier=" +'';
						System.OpenTargetPage( System.RootURL+url , "newform" );      
						  //var url = '/standard/reports/ht/fo/rpt_htfo00270_cash_daily_summary.aspx?p_checkout_date='+dtCashDailySummaryFrm.value+'&p_checkout_date_to='+dtCashDailySummaryTo.value+'&p_room_no='+''+'&p_pay_method='+'ALL'+'&p_tco_buspartner_pk='+''+ "&p_time_from=" +''+ "&p_time_to=" +''+ "&p_cashier=" +'';
							//System.OpenTargetPage( System.RootURL+url , "newform" );
					break;	
					case "opPaymentReport"://PaymentReport                                     
						  var url = '/standard/reports/60/30/rpt_60300010_cash_daily_summary2.aspx?p_date='+dtPaymentReport.value+'&p_room='+''+'&p_payment_method='+'ALL'+'&p_partner_PK='+''+"&p_time_frm=" +''+"&p_time_to=" +''+"&p_cashier=" +'';
						System.OpenTargetPage( System.RootURL+url , "newform" );   
					break;	
					case "opdaily_booking_source_statistic"://opdaily_booking_source_statistic                                    
						  var url = '/standard/reports/60/30/rpt_60300010_daily_bking_source_static.aspx?p_dtfrm='+dtBkingSrcStaticFrm.value+'&p_dtto='+dtBkingSrcStaticTo.value;
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break; 
					case "opdaily_market_segment"://opdaily_market_segment                                   
						  var url = '/standard/reports/60/30/rpt_60300010_market_segment.aspx?p_dtfrm='+dtMarketSegmentFrm.value;
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break;	
					case "opdaily_room_occupied"://opdaily_room_occupied                                    
						  var url = '/standard/reports/60/30/rpt_60300010_room_occupied_static.aspx?p_dtfrm='+dtroom_occupiedfrm.value+'&p_dtto='+dtroom_occupiedto.value;
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break;
					case "opdaily_nationality_statistic"://opdaily_nationality_statistic                                    
						  var url = '/standard/reports/60/30/rpt_60300010_nationality_static.aspx?p_dtfrm='+dt_nationality_frm.value+'&p_dtto='+dt_nationality_to.value;
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break;
					case "opdaily_company_statistic"://opdaily_company_statistic                                    
						  var url = '/standard/reports/60/30/rpt_60300010_company_static.aspx?p_dtfrm='+dt_company_frm.value+'&p_dtto='+dt_company_to.value;
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break;
					case "opdaily_house_use_statistic"://opdaily_house_use_statistic                                      
						  var url = '/standard/reports/60/30/rpt_60300010_house_use.aspx?p_dtfrm='+dt_house_use_frm.value+'&p_dtto='+dt_house_use_to.value;
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break;
					case "opdaily_complimentary_statistic"://opdaily_house_use_statistic                                    
						  var url = '/standard/reports/60/30/rpt_60300010_complimentary.aspx?p_dtfrm='+dt_complimentary_frm.value+'&p_dtto='+dt_complimentary_to.value;
							System.OpenTargetPage( System.RootURL+url , "newform" );
					break;
					case "opdaily_cancel_noshow"://opdaily_cancel_noshow                                    
						  var url = '/standard/reports/60/30/rpt_60300010_cancel_noshow.aspx?p_dtfrm='+dt_cancel_noshow_frm.value+'&p_dtto='+dt_cancel_noshow_to.value;
							System.OpenTargetPage( System.RootURL+url , "newform" ); 
					break;
					case "opDivisionRevenue"://usd 
							var url = '/standard/reports/60/30/rpt_60300010_consolidate.aspx?p_monthly='+dtDivisionRevenue.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );	
					break; 
					case "opdaily_company_statistic_bk_by"://opdaily_company_statistic  
						if(g_user_id=="smquang")
						{						
						  var url = '/standard/reports/60/30/rpt_60300010_company_static_bk.aspx?p_dtfrm='+dt_company_frm_bk_by.value+'&p_dtto='+dt_company_to_bk_by.value;
							System.OpenTargetPage( System.RootURL+url , "newform" );
						}
						else
						{///
					...
					case "opReservation_daily_report"://Reservation_daily_report                                    
						  var url = '/standard/reports/60/30/rpt_60300010_Reservation_daily_report.aspx?p_dtfrm='+Reservation_daily_report_from.value;
						  System.OpenTargetPage( System.RootURL+url , "newform" ); 
					break;
					case "opmarket_segment_from_to"://Market Segment report type date from to                                    
						  var url = '/standard/reports/60/30/rpt_60300010_market_segment_date_from_to.aspx?p_dtfrm='+dtMarketSegment_frm.value+'&p_dtto='+dtMarketSegment_to.value;
						  System.OpenTargetPage( System.RootURL+url , "newform" ); 
					break;
					case "opmarket_room_type_from_to"://room type report --> date from - to                                   
						  var url = '/standard/reports/60/30/rpt_60300010_room_type_date_from_to.aspx?p_dtfrm='+dtRoom_Type_frm.value+'&p_dtto='+dtRoom_Type_to.value;
						  System.OpenTargetPage( System.RootURL+url , "newform" ); 
					break; 
					case "opRoomRevenue_from_to"://room type report --> date from - to                                   
						  var url = '/standard/reports/60/30/rpt_60300010_room_revenue_monthly.aspx?p_dtfrm='+dtRoomRevenuefrm.value+'&p_dtto='+dtRoomRevenueTo.value;
						  System.OpenTargetPage( System.RootURL+url , "newform" ); 
					break;				
				}         
				...
				<tr>
					<td style="background-color:white;" valign="top">
						<table border="0" cellpadding="0" cellspacing="0" style="width:100%">
							...
							<tr height="height:24px" style="width:100%;"  valign="top">   
								<td width="2%" valign="middle" > 
										<input name="mnReport" type="radio" id="opmarket_segment_from_to" value="61"></td>
								<td valign="middle" style="font-size:12" width="23%" >MARKET SEGMENT(2)</td>
								<td align="left" valign="middle" class="" >  
									<gw:datebox id="dtMarketSegment_frm" lang="1" /> ~ <gw:datebox id="dtMarketSegment_to" lang="1" /></td>
								<td align="center" valign="middle" style="padding-top:10px;border-left:0">&nbsp;</td>
							</tr>
							<tr height="height:24px" style="width:100%;"  valign="top">   
								<td width="2%" valign="middle" > 
										<input name="mnReport" type="radio" id="opmarket_room_type_from_to" value="62"></td>
								<td valign="middle" style="font-size:12" width="23%" >Room Type Revenue</td>
								<td align="left" valign="middle" class="" >  
									<gw:datebox id="dtRoom_Type_frm" lang="1" /> ~ <gw:datebox id="dtRoom_Type_to" lang="1" /></td>
								<td align="center" valign="middle" style="padding-top:10px;border-left:0">&nbsp;</td>
							</tr>
							<tr height="height:24px" style="width:100%;"  valign="top">   
								<td width="2%" valign="middle" > 
										<input name="mnReport" type="radio" id="opRoomRevenue_from_to" value="63"></td>
								<td valign="middle" style="font-size:12" width="23%" >Room Revenue</td>
								<td align="left" valign="middle" class="" >  
									<gw:datebox id="dtRoomRevenuefrm" lang="1" /> ~ <gw:datebox id="dtRoomRevenueTo" lang="1" /></td>
								<td align="center" valign="middle" style="padding-top:10px;border-left:0">&nbsp;</td>
							</tr>
						</table>             
					</td>        
