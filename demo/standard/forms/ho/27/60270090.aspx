...
function OnReport()
 {
	...
	{		
		...
		var url = '/standard/reports/ho/27/rpt_ht_60270090_POS_Adjust_Inquiry.aspx?p_invoice_or_room_no='+txtInvoiceNo.text+'&p_dt_frm='+dtFrom.value+'&p_dt_to='+dtTo.value;  
...
<body>
    ...
    <gw:data id="data_htfo00130_1" onreceive="OnDataReceive(this)"> 
        <xml>
           <dso  type="grid"  function="ht_sel_60270090">
