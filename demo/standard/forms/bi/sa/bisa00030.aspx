...
function OnPopUp(pos)
{
    switch(pos)
    {
         case 'DetailConfirm':
            if ( grdConfirm.row > 0 )
            {
                var path = System.RootURL + '/standard/forms/bi/sa/bisa00031.aspx?type=APPROVE&slip_pk=' + grdConfirm.GetGridData( grdConfirm.row, G1_OS_PK);
         ...
         case 'DetailApprove':
            if ( grdApprove.row > 0 )
            {
                var path = System.RootURL + '/standard/forms/bi/sa/bisa00031.aspx?type=CANCEL&slip_pk=' + grdApprove.GetGridData( grdApprove.row, G2_OS_PK);
                var object = System.OpenModal( path, 1000, 600, 'resizable:yes;status:yes', this); 
...
<body>
    ...
    <gw:data id="dso_wh_list_approve" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="list" procedure="st_lg_sel_bisa00030_2" > 
                <input>
    ...
    <gw:data id="dso_wh_list_cancel" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="list" procedure="st_lg_sel_bisa00030_3" > 
                <input>
                    <input bind="txtUser_PK" /> 
                </input> 
                <output>
    ...
    <gw:data id="data_bisa00030" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid"  function="st_lg_SEL_bisa00030"  >
    ...
    <gw:data id="data_bisa00030_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="2" type="grid"  function="st_lg_SEL_bisa00030_1"  >
    ...
    <gw:data id="pro_bisa00030" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="st_lg_pro_bisa00030" > 
                <input>
    ...
    <gw:data id="pro_bisa00030_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="st_lg_pro_bisa00030_1" > 
                <input>
                    <input bind="txtSlipPK" /> 
                </input> 
                <output>
            ...
            <td>
                <table style="width: 100%; height: 100%">
                    <tr>
                        ...
                        <td style="width: 1%">
                            <gw:button id="btnViewDetail" img="popup" text="Detail" onclick="OnPopUp('DetailConfirm')" />
                        </td>
                    </tr>
                    <tr style="height: 99%">
                        <td colspan="9">
            ...
            <td>
                <table style="width: 100%; height: 100%">
                    <tr>
                        ...
                        <td style="width: 1%">
                            <gw:button id="btnViewDetail1" img="popup" text="Detail" onclick="OnPopUp('DetailApprove')" />
                        </td>
                    </tr>
                    <tr style="height: 99%">
                        <td colspan="13">
