...
//-------------------------------------------------
    function BodyInit()
    {
        var data1 = "<%=CtlLib.SetListDataSQL("select CODE, NAME from  comm.TCO_COMMCODE where del_if=0 and PARENT_CODE='RTYPE'" )%>|ALL|Select All"; 
...
<body>
    ...
    <gw:data id="data_htfo00060_01" onreceive=""> 
        <xml> 
           <dso id="1" type="grid" function="CRM.sp_sel_htfo00040_rm_popup" > 
                  <input bind="idGrid" > 
