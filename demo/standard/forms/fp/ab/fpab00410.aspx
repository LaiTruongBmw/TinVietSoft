...
function BodyInit()
{
    ...
    data = "<%=CtlLib.SetListDataSQL("SELECT pk,wh_id || ' * ' || wh_name  FROM tlg_in_warehouse  WHERE del_if = 0 AND USE_YN = 'Y' and nvl(parent_pk,0) = 0 ORDER BY wh_name  ASC" )%>||";    
...
<body>
    ...
    <gw:data id="data_fpab00410" onreceive="OnReceiveData(this)"> 
        <xml> 
           <dso id="1" type="grid" function="st_lg_sel_fpab00410" > 
                  <input bind="idGrid" > 
                    <input bind="lstWH" />
                    <input bind="lstGroup" />
                    <input bind="txtItem" />
