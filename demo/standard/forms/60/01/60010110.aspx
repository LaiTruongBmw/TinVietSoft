...
function onRowDoubleclk(index)
{
    switch(index)
    {
        case 0:
            ...
            {
                var fpath = System.RootURL + "/standard/forms/60/01/60010110_1p.aspx";
                ...
                if(aValue !=null)
                {
					...
					GridDetail.SetGridText(GridDetail.rows - 1, 5, GridSearch.GetGridData(GridSearch.row,3));// tco_bsuser_pk 
           ...
           case 1:
			...
			txtuserpk.SetDataText(GridSearch.GetGridData(GridSearch.row,3));
...
<!------------------------------------------------------------------------------->
  ...
  <gw:data id="getUser"> 
    <xml> 
        <dso type="grid" parameter="0" function="ac_sel_600100110_1" > 
            <input> 
 ...
 <!----------------------------------------------------------------------------->
   <gw:data id="data_kpac1012_2" onreceive="OnDataReceive(this)" >
        <xml>
            <dso type="grid" parameter="0,1,4,5" function="ac_sel_600100110_20" procedure="ac_upd_600100110_3">
	            ...
	            <table border="0" width="100%" cellpadding="0" cellspacing="0"  id="table5">
				    ...
				    <tr>
					    <td width="100%" >
					        <gw:grid   
	                            id="GridSearch"  
	                            header="Emp ID|Emp Name|UserID|_Charger|Tel No|Mobile|Address"
                                format="0|0|0|0|0|0|0" 
								aligns="0|0|0|0|0|0|0"
                                defaults="||||||"
                                widths="1000|2500|1500|1000|1500|1500|1500"
                                styles="width:100%; height:460" sorting="T"
                                acceptnulldate="T" 
		    ...
		    <tr>
		        <!--0_pk|1_Projectpk|2.Project code|3.Project name|4_user_id|5_tco_bsuser_pk-->
	             <td width="100%"  >
				        <gw:grid   
                            id="GridDetail"  
                            header="_pk|_projectpk|Company ID|Company name|user_id|_5_tco_bsuser_pk"   
                            format="0|0|0|0|0|0"  
                            aligns="0|0|0|0|0|0"  
                            defaults="|||||"  
                            editcol="1|1|1|1|1|1"  
