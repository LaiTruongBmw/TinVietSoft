...
public partial class rpt_hrem00800_1 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		string p_user,p_wg,p_emp_search,p_tco_org_pk,p_kind,p_type,p_from_regdate,p_to_regdate,p_status,p_lang ;
		...
		if(p_lang == "ENG")
		{
			TemplateFile = "rpt_hrem00800_1_eng.xls";
		}
        else
			TemplateFile = "rpt_hrem00800_1_vie.xls";
		
        string TempFile = "../../../../system/temp/rpt_hrem00800_1" + Session["User_ID"].ToString() + ".xls";
        ...
        string para = "'" + p_tco_org_pk + "','" + p_wg + "','"+ p_emp_search  + "','" + p_kind +"','"+p_type+"','"+p_from_regdate+
						"','" +p_to_regdate+"','" +p_status+"','"+p_lang+"'";
		
		DataTable dt_emp = CtlLib.TableReadOpenCursor("ST_HR_RPT_HREM00800_1", para);
