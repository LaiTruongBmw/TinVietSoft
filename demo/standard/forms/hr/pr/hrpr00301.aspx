...
<body>
    ...
    <!---------------------------------------------------------------->
    <gw:data id="data_hrpr00301_1" onreceive="OnReceiveData(this)"> 
    <xml> 
           <dso id="1" type="grid" function="ST_LG_sel_hrpr00301_1" > 
                  <input bind="idGrid" >
                    <input bind="lstGroup" />
                    <input bind="txtItem" />
                  </input> 
