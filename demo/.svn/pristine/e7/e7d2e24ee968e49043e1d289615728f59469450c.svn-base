...
<%
    ...
    dt  = CtlLib.TableReadOpenCursor("st_lg__rpt_dscd00021");
    dt1 = CtlLib.TableReadOpenCursor("st_lg__rpt_dscd00021_1", "'" + p_master_pk + "'");
    dt2 = CtlLib.TableReadOpenCursor("st_lg__rpt_dscd00021_2", "'" + p_master_pk + "'");
    dt3 = CtlLib.TableReadOpenCursor("st_lg__sel_agds00050_5", "'65','FAC1'");
%>
<head>
