...
public partial class rpt_602500230_Guest_Profile : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_602500230_Guest_Profile.xls";
        string TempFile = "../../../../system/temp/rpt_602500230_Guest_Profile_" + Session["User_ID"].ToString() + ".xls";
        ...
        para = "'" + l_guest_phone_mail + "','" + l_dtfrm + "','" + l_dtto + "'";
        dt = CtlLib.TableReadOpenCursor("rpt_60250230_guest_profile", para); 
        //-----header---   
