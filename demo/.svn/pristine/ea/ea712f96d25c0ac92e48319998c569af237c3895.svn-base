...
function OnPopUp(pos)
{
    switch(pos)
    {
         case 'POConfirm':
            if ( grdApprove.row > 0 )
            {
                var path = System.RootURL + '/standard/forms/ds/re/dsre00021.aspx?trans_pk=' + grdApprove.GetGridData( grdApprove.row, G1_PK);
         ...
         case 'POApprove':
            if ( grdCancel.row > 0 )
            {
                    var path = System.RootURL + '/standard/forms/ds/re/dsre00022.aspx?trans_pk=' + grdCancel.GetGridData( grdCancel.row, G2_PK);
                    var object = System.OpenModal( path, 800, 600, 'resizable:yes;status:yes', this);
                if ( object != null )                    
                {                
			OnSearch('grdApprove');
...
{    
    ...
    var url =System.RootURL + "/standard/reports/ds/re/rpt_dsre00020.aspx?dtFrom="+txtDateFrom.text+"&dtTo="+txtDateTo.text ;
...
function OnReport()
{
      var url =System.RootURL + '/standard/reports/ds/re/rpt_dsre00020.aspx?p_master_pk='+ grdApprove.GetGridData(grdApprove.row, G1_PK);
      System.OpenTargetPage(url);      
}    
</script>
...
<body>
    ...
    <gw:data id="data_dsre00020" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid"  function="st_lg_SEL_dsre00020"  >
    ...
    <gw:data id="data_dsre00020_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="2" type="grid"  function="st_lg_SEL_dsre00020_1"  >
    ...
    <gw:data id="pro_dsre00020" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="st_lg_pro_dsre00020" > 
                <input>
    ...
    <gw:data id="pro_dsre00020_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="st_lg_pro_dsre00020_1" > 
                <input>
                    <input bind="txtInComePK" /> 
                </input> 
                <output>
    ...
    <gw:data id="pro_dsre00020_3" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="st_lg_pro_dsre00020_3" > 
                <input>
                    <input bind="txtInComePK" />
