...
<%    
    ...
    dt1 = CtlLib.TableReadOpenCursor("st_lg__rpt_dsbs00060_1", para);
    ...
    <x:CF>Bitmap</x:CF>
        ...
        <tr height="34" style='mso-height-source: userset; height: 25.5pt'>
            ...
            <td class="xl49" width="101" style='border-top: none; border-left: none; width: 76pt'
                x:num="111111">
                <span style='mso-spacerun: yes'></span>111,111.00
            </td>
            <td class="xl41" style='border-top: none; border-left: none'>
                &nbsp;
            </td>
