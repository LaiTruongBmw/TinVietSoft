...
public partial class rpt_60300010_room_occupied_static : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_60300010_room_occupied_static.xls";
        string TempFile = "../../../../system/temp/rpt_60300010_room_occupied_static_" + Session["User_ID"].ToString() + ".xls";
        ...
        dt = CtlLib.TableReadOpenCursor("rpt_60300010_room_occupi_sta", para);
        //-----header---   
        ...
        if (dt.Rows.Count > 0)
        {
			...
			exSheet.Cells[4, 13].Value = dt.Rows[0]["date_header"].ToString(); 
        }
			...
			for (int l_row = 1; l_row <= dt.Rows.Count; l_row++)
			{
				for (int col = 0; col <= 14; col++)
				{
					if (col == 0||col == 1)
					{
						...
						{
							exSheet.Cells[5 + l_row, col + 1].Value = dt.Rows[l_row - 1][col].ToString();
							exSheet.Cells[l_row + 5, col + 1].HorizontalAlignment = XlHAlign.xlHAlignCenter;
						}
					}
					else
					{
