...
function BodyInit()
{
    ...
    txtSTitemQuery.text =  "<%=Request.querystring("p_item_cd")%>";
...
<body>
    ...
    <gw:data id="lst_kbal00010_4" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="list" procedure="<%=l_user%>lg_sel_kbal00010_4" > 
                <input> 
    ...
    <gw:data id="lst_kbal00010_5" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="list" procedure="<%=l_user%>lg_sel_kbal00010_5" > 
                <input> 
    ...
    <gw:data id="data_kbal00010" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid" parameter="0,1" function="<%=l_user%>lg_sel_kbal00010" > 
                <input>
                    <input bind="cboCompanyList" /> 
    ...
    <gw:data id="pro_kbal00010" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_kbal00010" > 
                <input>
                    <input bind="dtMonth" />
    ...
    <gw:data id="data_kbal00010_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid" parameter="0,1,2,3,4,5,6,7" function="<%=l_user%>lg_sel_kbal00010_1"  procedure="<%=l_user%>lg_upd_kbal00010_1"  > 
                <input>
                    <input bind="dtMonth" /> 
                    <input bind="txtSTItemPK" />                  
                </input> 
