...
<%    
    ...
    string p_list_date = Request.QueryString["p_list_date"];
    string p_from_date = Request.QueryString["p_from_date"];
    string p_to_date = Request.QueryString["p_to_date"];
    string p_item = Request.QueryString["p_item"];
    string p_bill_to = Request.QueryString["p_bill_to"];

    string para = "'" + p_list_date + "','" + p_from_date + "','" + p_to_date + "','" + p_item + "','" + p_bill_to + "'";
    DataTable dt, dt1;
    dt = CtlLib.TableReadOpen(strSQL);
    //dt1 = CtlLib.TableReadOpenCursor("SALE.sp_rpt_dsbs00020_1", para);
%>
<head>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1264 style='border-collapse:
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=4 height=20 class=xl66 style='height:15.0pt'>WI No : 123456<span
  style='mso-spacerun:yes'></span>Date :<font class="font14"> 07/01/2011</font></td>
  <td class=xl35></td>
 ...
 <tr height=25 style='mso-height-source:userset;height:18.75pt'>
  ...
  Date<font class="font17"> : 07/01/2011 ~ 07/05/2011</font></td>
  <td class=xl39></td>
  <td colspan=3 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=25 style='mso-height-source:userset;height:18.75pt'>
  <td height=25 class=xl40 style='height:18.75pt'>To:</td>
  <td class=xl41>Line 01</td>
  <td class=xl42></td>
 ...
 <tr class=xl45 height=39 style='mso-height-source:userset;height:29.25pt'>
  <td height=39 class=xl46 width=49 style='height:29.25pt;width:37pt' x:num>1</td>
  <td class=xl47 width=101 style='width:76pt'>07/01/2011 ~ 07/01/2011</td>
  <td class=xl47 width=151 style='width:113pt'>SHILLA BAGS CO., LTD.</td>
  <td class=xl83 width=194 style='width:146pt'>#5C3831<br>
    5 ZIPPER - RIVET GREY</td>
  <td class=xl48 width=86 style='width:65pt'>RIVET GREY</td>
  <td class=xl49 width=53 style='width:40pt'>M</td>
  <td class=xl50 width=71 style='width:53pt' x:num>240</td>
  <td class=xl51 width=130 style='width:98pt'>SV11RB009 (110625-13)ADD9</td>
  <td class=xl52 width=113 style='width:85pt' x:num="40730">7/6/2011</td>
  <td class=xl53 width=124 style='width:93pt'>&nbsp;</td>
  <td colspan=3 class=xl45 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl54 height=39 style='mso-height-source:userset;height:29.25pt'>
  ...
  <td class=xl55 width=71 style='width:53pt' x:err="#REF!" x:fmla="=SUM(#REF!)">#REF!</td>
