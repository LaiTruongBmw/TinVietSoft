...
function OnReport(obj)
 {
	 ...
	 if(obj=='2')
	{
		 if(grdMinibarReport.rows > 1)
		 {
			var url = '/standard/reports/60/28/rpt_60280150_rvn_tour_detail.aspx?p_dtfrom='+dtFromDate.GetData()+"&p_dtto="+dtToDate.GetData(); 
...
<body>
    ...
    <xml> 
        <dso  type="grid" function="st_ht_sel_60280150"> 
