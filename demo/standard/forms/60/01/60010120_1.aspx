...
{   
  lstDept.SetDataText("<%=CtlLib.SetListDataSQL("SELECT PK, ORG_ID ||'-'|| ORG_NM FROM TCO_ORG WHERE DEL_IF = 0 ORDER BY 2")%>|ALL|Select All");
  lstDept.value = "ALL";
}
...
<gw:data id="data_gfnt00070_11"  > 
    <xml> 
        <dso type="grid" parameter="0,1,2" function="ac_sel_60010120_1_1" > 
            <input> 
                <input bind="lstDept" />
                <input bind="lstKey" />
