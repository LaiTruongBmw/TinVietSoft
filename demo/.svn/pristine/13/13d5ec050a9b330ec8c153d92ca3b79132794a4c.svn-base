...
function OnPrint()
{
    var  url= System.RootURL + "/standard/standard/reports/gf/da/gfda00090.aspx?p_com_pk="+lstCompany.value+"&p_date_fr="+dtDate_fr.value
...
<body style="margin:0; padding:0;">
    ...
    <gw:data id="dso_sel_ap_balance" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" function="sp_sel_fmgf00500">
                <input bind="grid">
