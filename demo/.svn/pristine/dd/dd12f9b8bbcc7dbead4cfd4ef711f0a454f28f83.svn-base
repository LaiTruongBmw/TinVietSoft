...
public partial class rpt_bisc00140_grand : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            exSheet.Cells[l_pos + i, C_GRP_NM].Value = dtDetail.Rows[i]["grp_nm"];
            exSheet.Cells[l_pos + i, C_ITEM_CODE].Value = dtDetail.Rows[i]["item_code"];
            exSheet.Cells[l_pos + i, C_ITEM_NAME].Value = dtDetail.Rows[i]["item_name"];
            exSheet.Cells[l_pos + i, C_UOM].Value = dtDetail.Rows[i]["uom"];
            exSheet.Cells[l_pos + i, C_STOCK_QTY].Value = dtDetail.Rows[i]["stock_qty"];

            exSheet.Cells[l_pos + i, C_WH_1].Value = dtDetail.Rows[i]["qty1"];
            exSheet.Cells[l_pos + i, C_WH_2].Value = dtDetail.Rows[i]["qty2"];
            exSheet.Cells[l_pos + i, C_WH_3].Value = dtDetail.Rows[i]["qty3"];
            exSheet.Cells[l_pos + i, C_WH_4].Value = dtDetail.Rows[i]["qty4"];
            exSheet.Cells[l_pos + i, C_WH_5].Value = dtDetail.Rows[i]["qty5"];
            exSheet.Cells[l_pos + i, C_WH_6].Value = dtDetail.Rows[i]["qty6"];
            exSheet.Cells[l_pos + i, C_WH_7].Value = dtDetail.Rows[i]["qty7"];
            exSheet.Cells[l_pos + i, C_WH_8].Value = dtDetail.Rows[i]["qty8"];
            exSheet.Cells[l_pos + i, C_WH_9].Value = dtDetail.Rows[i]["qty9"];
            exSheet.Cells[l_pos + i, C_WH_10].Value = dtDetail.Rows[i]["qty10"];
        ...
        exSheet.Cells[dtDetail.Rows.Count + l_pos, C_WH_1].Value = String.Format("{0:0,0}", sum_qty1);
        exSheet.Cells[dtDetail.Rows.Count + l_pos, C_WH_2].Value = String.Format("{0:0,0}", sum_qty2);
        exSheet.Cells[dtDetail.Rows.Count + l_pos, C_WH_3].Value = String.Format("{0:0,0}", sum_qty3);
        exSheet.Cells[dtDetail.Rows.Count + l_pos, C_WH_4].Value = String.Format("{0:0,0}", sum_qty4);
        exSheet.Cells[dtDetail.Rows.Count + l_pos, C_WH_5].Value = String.Format("{0:0,0}", sum_qty5);
        exSheet.Cells[dtDetail.Rows.Count + l_pos, C_WH_6].Value = String.Format("{0:0,0}", sum_qty6);
        exSheet.Cells[dtDetail.Rows.Count + l_pos, C_WH_7].Value = String.Format("{0:0,0}", sum_qty7);
        exSheet.Cells[dtDetail.Rows.Count + l_pos, C_WH_8].Value = String.Format("{0:0,0}", sum_qty8);
        exSheet.Cells[dtDetail.Rows.Count + l_pos, C_WH_9].Value = String.Format("{0:0,0}", sum_qty9);
        exSheet.Cells[dtDetail.Rows.Count + l_pos, C_WH_10].Value = String.Format("{0:0,0}", sum_qty10);
