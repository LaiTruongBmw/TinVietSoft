...
var G2_3_DEPT_NAME       	= 0,
 ...
 function FormatGrid()
 {
	...
	data = "<%=CtlLib.SetListDataSQL("SELECT pk, wh_id || ' * ' || wh_name  FROM tlg_in_warehouse  WHERE del_if = 0 and use_yn='Y' ORDER BY wh_id  ASC" )%>||SELECT ALL";    
	...
	data = "<%=CtlLib.SetListDataSQL("select a.pk, lpad('-',level ,'-') || ' ' || a.grp_cd || ' - ' || a.grp_nm from tlg_it_itemgrp a where a.del_if = 0 and a.use_yn='Y' and a.group_type is not null connect by prior a.pk = A.P_PK start with A.P_PK is null order siblings by grp_cd " )%>||SELECT ALL";       
 ...
 function OnReport(pos)
 {
	...
	{
		case 'FOSE01':		 
				var url = System.RootURL + '/standard/reports/ep/bp/rpt_epbp00400_FOSE01.aspx?p_from_dt='+ dtFromTab1.value +'&p_to_dt='+dtToTab1.value +'&p_wh_type=' + lstWHTypeTab1.value +'&p_wh_pk=' + lstWarehouseTab1.value +'&p_group_pk=' + lstGroupTab1.value +'&p_item=' + txtItemTab1.text +'&p_partner_pk=' + txtPartnerPKTab1.text ;
		   
				System.OpenTargetPage(url); 		 	
		break;
		
		case 'FOSE02':		 
				var url = System.RootURL + '/standard/reports/ep/bp/rpt_epbp00400_FOSE02.aspx?p_from_dt='+ dtFromTab2.value +'&p_to_dt='+dtToTab2.value +'&p_wh_type=' + lstWHTypeTab2.value +'&p_wh_pk=' + lstWarehouseTab2.value +'&p_item=' + txtItemTab2.text +'&p_partner_pk=' + txtPartnerPKTab2.text +'&p_partner_group_pk=' + txtPartnerGroupTab2.text;
		   
				System.OpenTargetPage(url); 		 	
		break;

		case 'FOSE03':		 
				var url = System.RootURL + '/standard/reports/ep/bp/rpt_epbp00400_FOSE03.aspx?p_from_dt='+ dtFromTab1.value +'&p_to_dt='+dtToTab1.value +'&p_wh_type=' + lstWHTypeTab1.value +'&p_wh_pk=' + lstWarehouseTab1.value +'&p_group_pk=' + lstGroupTab1.value +'&p_item=' + txtItemTab1.text +'&p_partner_pk=' + txtPartnerPKTab1.text ;
		   
				System.OpenTargetPage(url); 			 	
		break; 	

		case 'FOSE04':		 
				var url = System.RootURL + '/standard/reports/ep/bp/rpt_epbp00400_FOSE04.aspx?p_from_dt='+ dtFromTab1.value +'&p_to_dt='+dtToTab1.value +'&p_wh_type=' + lstWHTypeTab1.value +'&p_wh_pk=' + lstWarehouseTab1.value +'&p_group_pk=' + lstGroupTab1.value +'&p_item=' + txtItemTab1.text +'&p_partner_pk=' + txtPartnerPKTab1.text ;
		   
				System.OpenTargetPage(url); 	 		 	
		break; 

		case 'FOSE05':		 
				var url = System.RootURL + '/standard/reports/ep/bp/rpt_epbp00400_FOSE05.aspx?p_from_dt='+ dtFromTab1.value +'&p_to_dt='+dtToTab1.value +'&p_wh_type=' + lstWHTypeTab1.value +'&p_wh_pk=' + lstWarehouseTab1.value +'&p_group_pk=' + lstGroupTab1.value +'&p_item=' + txtItemTab1.text +'&p_partner_pk=' + txtPartnerPKTab1.text ;
		   
				System.OpenTargetPage(url); 	 		 	
		break;

		case 'FOSE06':		 
				var url = System.RootURL + '/standard/reports/ep/bp/rpt_epbp00400_FOSE06.aspx?p_from_dt='+ dtFromTab1.value +'&p_to_dt='+dtToTab1.value +'&p_wh_type=' + lstWHTypeTab1.value +'&p_wh_pk=' + lstWarehouseTab1.value +'&p_group_pk=' + lstGroupTab1.value +'&p_item=' + txtItemTab1.text +'&p_partner_pk=' + txtPartnerPKTab1.text ;
...
function OnPopUp(pos)
{
	...
	{		 
		case 'Report_Tab1':			 			
			var path = System.RootURL + '/standard/formsep/bp/epbp00403.aspx';
			var object = System.OpenModal( path ,400, 300 ,  'resizable:yes;status:yes',this);					 
		break; 

		case 'Report_Tab2':			 			
			var path = System.RootURL + '/standard/formsep/bp/epbp00404.aspx';
			var object = System.OpenModal( path ,400, 300 ,  'resizable:yes;status:yes',this);					 
		break; 		
	}	 
} 
...
<body>   
    ...
    <gw:data id="data_epbp00390_1_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="st_lg_sel_epbp00400_1_1" > 
    ...
    <gw:data id="data_epbp00390_1_2" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="st_lg_sel_epbp00400_1_2" > 
    ...
    <gw:data id="pro_epbp00390_1_3" onreceive="OnDataReceive(this)">
        <xml>
            <dso  type="list" procedure="st_lg_pro_epbp00400_1_3" >
                <input>
                    <input bind="lstWHTypeTab1" />
                </input>
                <output>
    ...
    <gw:data id="data_epbp00390_2_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="st_lg_sel_epbp00400_2_1" > 
    ...
    <gw:data id="data_epbp00390_2_2" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="st_lg_sel_epbp00400_2_2" > 
    ...
    <gw:data id="data_epbp00390_2_3" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="st_lg_sel_epbp00400_2_3" > 
                ...
                <table style="width: 100%; height: 100%" border="0">
                    <tr>
						...
						<td style="width: 1%" align="right">
                            <gw:button id="ibtnSearchTab2" img="search" alt="Search" text="Search" onclick="OnSearch('Search_Tab2')" />
                        </td>
                    </tr>                                       
                    <tr style="height: 29%">
                        <td colspan="4">
            ...
            <td style="width: 70%" id='right'>
                <table style="width: 100%; height: 100%" border="0">
                    <tr style="height: 1%"> 
                        ...
                        <td style="width: 1%" align="right">
                            <gw:button img="excel" alt="Report" id="btnReport" onclick="OnPopUp('Report_Tab2')" />
                        </td>
						<td style="width: 1%" align="right">
                            <gw:button id="ibtnSearchTab2_1" img="search" alt="Search" text="Search" onclick="OnSearch('Detail_Tab2')" />
                        </td>
            ...
            <td style="width: 30%" id='left' >
                <table style="width: 100%; height: 100%" border="0">
                    <tr>
						...
						<td style="width: 1%" align="right">
                            <gw:button id="ibtnSearchTab1" img="search" alt="Search" text="Search" onclick="OnSearch('Search_Tab1')" />
                        </td>
                    </tr>                    
                    <tr>
                        <td style="width: 5%" align="right">
            ...
            <td style="width: 70%" id='right'>
                <table style="width: 100%; height: 100%" border="0">
                    <tr style="height: 1%"> 
                        ...
                        <td style="width: 1%" align="right">
                            <gw:button img="excel" alt="Report" id="btnReport" onclick="OnPopUp('Report_Tab1')" />
                        </td>
						<td style="width: 1%" align="right">
                            <gw:button id="ibtnSearchTab1_1" img="search" alt="Search" text="Search" onclick="OnSearch('Detail_Tab1')" />
                        </td>
