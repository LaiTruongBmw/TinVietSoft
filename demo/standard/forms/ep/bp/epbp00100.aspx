...
<script>
    ...
    function OnDataReceive(obj) 
	{
        switch (obj.id) 
		{
            case 'data_epbp00100':  
				...
				grdDetail.Subtotal( 0, 2,-1, '8!9!10!11!12!15!17!19!21!23!25!27');
            break;
        }
    }	 
    ...
    function OnReport() 
	{
		...
		var url = System.RootURL + "/standard/reports/ep/bp/rpt_epbp00100.aspx?p_from_dt=" + dtFrom.value + "&p_to_dt=" + dtTo.value + "&p_slip_cust=" + txtSlipCust.text + "&p_group=" + lstGroup.value + "&p_item=" + txtItem.text + "&p_bal_yn=" + chkBal.value;
...
<body>
    ...
    <table style="width: 100%; height: 100%">
        <tr id='top' style="height: 1%">
			...
			<td style="width: 1%" align="right">
                <gw:button id="btnPrint" img="excel" alt="Print" text="Report" onclick="OnReport()" />
            </td>
        </tr>
        <tr style="height: 99%">
            <td colspan="14">
