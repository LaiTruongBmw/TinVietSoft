...
<script>
 ...
 function OnReport()
 {
	...
	{
		var url = '/standard/reports/ho/25/rpt_60250200_list_transaction_posted.aspx?p_dt_from='+ dtFrom.value+'&p_dt_to='+dtTo.value+'&p_crt_by='+txtCashierID.text+'&p_services_name='+lstTableName.value+'&p_location='+lstLocation.value+'&p_time_from='+txtFromTime.text+'&p_time_to='+txtToTime.text;  
