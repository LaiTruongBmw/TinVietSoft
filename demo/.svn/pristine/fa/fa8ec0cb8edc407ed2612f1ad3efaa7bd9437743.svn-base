        ...
        <tr style="height: 70%">
            <td style="width: 100%" align="left">
                <gw:radio id="radType" value="0" styles="width:100%"> 
                    ...
                    <span value="0">STANDARD</span> <br/>
                    <span value="1">SONGWOL</span> <br/>
					<span value="2">SAMIL</span> <br/>
					
					<span value="3">AMB (eng-vietnamese)</span> <br/>
					<span value="4">AMB (eng)</span> <br/>
					
					<span value="5">DURING</span> <br/>
                </gw:radio>
            </td>
        </tr>
    </table>
