    ...
    switch(pos)
    {
        case '1':   
	            ...
	            //System.OpenTargetPage( System.RootURL+url , "newform" );  
				 ...
				 var url ='/standard/reports/60/28/rpt_ht_60280180_RoomSummaryMonthly.aspx?p_room_no='+txtRoomNo.text+'&p_checkout_date_frm='+dtFrom.value+'&p_checkout_date_to='+dtTo.value;
	            System.OpenTargetPage( System.RootURL+url , "newform" ); 
	    ...
	    case '2'://col 24:room_allocate_pk,27 code PMT
			if ( grdRoomAllocate.row > 0 ){
				if(grdRoomAllocate.GetGridData(grdRoomAllocate.row,25) != ''){
					 ...
					 var url = '/standard/reports/60/28/rpt_60280180_Guest_Invoice.aspx?p_tht_room_allocate_pk='+grdRoomAllocate.GetGridData(grdRoomAllocate.row,25)+'&p_from_date='+dtFrom.value+'&p_to_date='+dtTo.value+'&p_cashier_pk='+user_pk+'&p_printed_yn='+"Y"+'&p_paymethod='+grdRoomAllocate.GetGridData(grdRoomAllocate.row,28)+'&p_folio_type='+""; 
					 System.OpenTargetPage( System.RootURL+url , "newform" );
...
<body>
    ...
    <gw:data id="data_htfo00250" onreceive="OnDataReceive(this)"> 
        <xml>
           <dso  type="grid"  function="st_ht_sel_60280180" >
        ...
        <tr style="height: 50%">
            <td>
                <table style="width: 100%; height: 100%">
					...
					<td style="width: 30%; white-space: nowrap" align="center" id="id_date">
                            From:
                            <gw:datebox id="dtFromDTl" lang="1" styles="width:40%" onchange="OnSearchLocation()" />
							~<gw:datebox id="dtToDTl" lang="1" styles="width:40%" onchange="OnSearchLocation()" />
                        </td>
