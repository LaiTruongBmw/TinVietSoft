...
public partial class rpt_bisc00030_DR08 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataTable dtMaster = CtlLib.TableReadOpenCursor("st_lg_rpt_bisc00030_DR08_1", l_parameter);
		DataTable dtDetail = CtlLib.TableReadOpenCursor("st_lg_rpt_bisc00030_DR08_2", l_parameter);
