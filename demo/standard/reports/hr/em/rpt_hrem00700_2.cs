...
public partial class rpt_hrem00700_2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		string p_user,p_select_dt,p_from_dt,p_to_dt,p_thr_group_pk,p_search_by,p_emp_search,p_status,
		p_tco_dept_pk,p_tco_org_pk,p_level,p_nation,p_contract_type,p_lang;
        ...
        string TemplateFile;
		if (p_lang=="ENG")
			TemplateFile = "rpt_hrem00700_2_eng.xls";
		else
			TemplateFile= "rpt_hrem00700_2_vie.xls";
        string TempFile = "../../../../system/temp/rpt_hrem00700_2" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dt_emp = CtlLib.TableReadOpenCursor("ST_HR_RPT_HREM00700_2", para);
