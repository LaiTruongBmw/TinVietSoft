...
public partial class rpt_hrem01000_1 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		string p_user,p_tco_org_pk,p_wg,p_emp_search,p_from_dt,p_to_dt,p_resign_type,p_nation,p_lang ;
		...
		if(p_lang == "ENG")
		{
			TemplateFile = "rpt_hrem01000_1_eng.xls";
		}
        else
			TemplateFile = "rpt_hrem01000_1_vie.xls";
		
        string TempFile = "../../../../system/temp/rpt_hrem01000_1" + Session["User_ID"].ToString() + ".xls";
        ...
        string para = "'" + p_tco_org_pk + "','"+ p_emp_search + "','" + p_from_dt +
						"','" + p_to_dt + "','" + p_resign_type + "','" +p_nation+"','"+p_lang+"'";
		
		DataTable dt_emp = CtlLib.TableReadOpenCursor("ST_HR_RPT_HREM01000_1", para);
