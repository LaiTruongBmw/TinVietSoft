            ...
            switch (lstLang.GetData())
            {
                case "VIE":
                    var url = '/standard/reports/gf/lv/gflv00020_rpt_VAT_In1.aspx?compk=' + lstCompany.GetData();
                     ...
                     url = url + '&BalType=' + rdoType.GetData() + '&p_dtfr=' + dtfrdate.GetData() + '&p_dtto=' + dttodate.GetData(); 
...
function OnGetAccount(){
    var fpath = System.RootURL + "/standard/forms/gf/lv/gflv00020_vas_popup.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + 'Y' + "&val2=" + 'Y' + "&val3=" + lstCompany.GetData() + "&dsqlid=ac_sel_60120150pp";
...
<body style="margin: 0; padding: 0;">
    <gw:data id="dso_get_rate" >
        <xml> 
            <dso type="process" procedure="ac_pro_60120150get_rate"> 
                <input> 
                     <input bind="txt_date"/>
    ...
    <gw:data id="dso_sel_grd_vat_inquiry" onreceive="OnSum()">
        <xml>
            <dso type="grid" function="ac_sel_60120150_inquiry">
                <input bind="grid">
                    <input bind="lstCompany"/>
                    <input bind="dtMonth"/>
