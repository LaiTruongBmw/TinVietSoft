...
{ 
    ...
    data = "<%=CtlLib.SetListDataSQL("SELECT TRANS_CODE ,TRANS_CODE || ' - ' || trans_name  FROM tlg_in_trans_code  WHERE del_if = 0 and ( trans_type = 'I' or trans_type = 'O' )ORDER BY trans_code" )%>||";    
...
<body>
    ...
    <gw:data id="data_bisc00023" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid" function="st_lg_sel_bisc00023" > 
                <input> 
