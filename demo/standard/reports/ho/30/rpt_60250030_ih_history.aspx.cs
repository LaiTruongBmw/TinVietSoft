...
public partial class rpt_60250030_ih_history : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        for (int l_row = 0; l_row < dt.Rows.Count; l_row++)
        {
				...
				exSheet.Cells[l_first_row + l_row, 2].Value = dt.Rows[l_row]["AUDIT_DATE"];
				exSheet.Cells[l_first_row + l_row, 3].Value = dt.Rows[l_row]["customer_type"];
				exSheet.Cells[l_first_row + l_row, 4].Value = dt.Rows[l_row]["last_name"];
				exSheet.Cells[l_first_row + l_row, 5].Value = dt.Rows[l_row]["last_name"];
				exSheet.Cells[l_first_row + l_row, 6].Value = dt.Rows[l_row]["GENDER"];
				exSheet.Cells[l_first_row + l_row, 7].Value = dt.Rows[l_row]["NATION"];
				exSheet.Cells[l_first_row + l_row, 8].Value = dt.Rows[l_row]["checkin_date"];
				exSheet.Cells[l_first_row + l_row, 9].Value = dt.Rows[l_row]["checkout_date"];
				exSheet.Cells[l_first_row + l_row, 10].Value = dt.Rows[l_row]["advance_amt"];
				
				exSheet.Cells[l_first_row + l_row, 11].Value = dt.Rows[l_row]["room_type"];
				exSheet.Cells[l_first_row + l_row, 12].Value = dt.Rows[l_row]["room_no"];
				exSheet.Cells[l_first_row + l_row, 13].Value = dt.Rows[l_row]["room_charge"];
				
				exSheet.Cells[l_first_row + l_row, 14].Value = dt.Rows[l_row]["amt_extrabed"];
				exSheet.Cells[l_first_row + l_row, 15].Value = dt.Rows[l_row]["BREAKFAST_AMT"];
				exSheet.Cells[l_first_row + l_row, 16].Value = dt.Rows[l_row]["other_room_fee"];
				exSheet.Cells[l_first_row + l_row, 17].Value = dt.Rows[l_row]["fnb_hotel_amt"];
				exSheet.Cells[l_first_row + l_row, 18].Value = dt.Rows[l_row]["minibar_amt"];
				exSheet.Cells[l_first_row + l_row, 19].Value = dt.Rows[l_row]["laundry_amt"];
				exSheet.Cells[l_first_row + l_row, 20].Value = dt.Rows[l_row]["others_amt"];
				exSheet.Cells[l_first_row + l_row, 21].Value = dt.Rows[l_row]["spa_amt"];
				exSheet.Cells[l_first_row + l_row, 22].Value = dt.Rows[l_row]["shop_amt"];
				exSheet.Cells[l_first_row + l_row, 23].Value = dt.Rows[l_row]["adjust_amt"];
								
				if (dt.Rows[l_row]["room_no"].ToString() == "Total" )
				{
					Color color1 = ColorTranslator.FromHtml("0xFFFF00");
					exSheet.Cells[l_first_row + l_row,1, l_first_row + l_row, 23].Interior.Color = color1;
				}
				if (dt.Rows[l_row]["room_no"].ToString() == "GrandTotal")
				{
					Color color11 = ColorTranslator.FromHtml("0x808080");
					exSheet.Cells[l_first_row + l_row,1, l_first_row + l_row, 23].Interior.Color = color11;
				}
				if (dt.Rows[l_row]["room_no"].ToString() == "ALL")
				{
					Color color11 = ColorTranslator.FromHtml("0xFFA07A");
					exSheet.Cells[l_first_row + l_row,1, l_first_row + l_row, 23].Interior.Color = color11;
				}
					//#FFA07A
