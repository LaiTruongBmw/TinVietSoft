...
/// </summary>
public class CtlLib : System.Web.UI.Page
{
    ...
    public static string RenderControlHTML(string p_control_id, string p_output_control)
    {
        ...
        try
        {
            ...
            command.CommandText = "Call ctl.sp_sel_write_control('" + p_control_id + "','" + p_output_control + "',:p_rtn_cur)";
    ...
    public static string SetListDataSQL(string sql)
    {
        ...
        try
        {
            DataTable dt = TableReadOpen(sql.Replace(@"\", " "));
