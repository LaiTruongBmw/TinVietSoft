...
<gw:data id="dsoAccountT"  onreceive="" > 
    <xml> 
        <dso id="1" type="grid" function="<%=Request.querystring("dsqlid")%>" > 
            <input bind="idGrid" > 
                <input bind="txtCode"/> 
                <input bind="txtName"/> 
                <input bind="txtName2"/>
            ...
            <tr height="15%">
	            <td > 
					...
					<tr>
						...
						<td >
							<gw:textbox id="txtCode" styles="width:65%;" onenterkey="OnSearch()"/><gw:datebox type='year' id="dtYear" onchange="OnSearch()" styles="width:35%"/>							
						</td>
						<td align="right;" width="1%">
							<% If (Session("CODEADMIN_YN") = "Y") Then%>
							<gw:imgBtn id="btnDictionary" img="dictionary"   style="width:1%;" alt="Dictionary"  onclick="System.GetDataLanguage_Popup(document,window.location.toString(),'<%=Session("SESSION_LANG")%>','<%=Session("CODEADMIN_YN")%>');"/>
                            <%End If%>
						</td>
		            </tr>
		            <tr>
						<td width="25%" align="right">Account Name</td>
						<td colspan="2"><gw:textbox id="txtName" styles="width:100%;height:20" onenterkey="OnSearch()"/></td>
					</tr>  
		            <tr>
						<td width="25%" align="right">Upper Account Name</td>
						<td colspan="2"><gw:textbox id="txtName2" styles="width:100%;height:20" onenterkey="OnSearch()"/></td>
					</tr>		        
				    </table>
		        </td>
	    	</tr>
                    ...
                    <tr>
			    	    <td height="80%">   
					        <gw:grid   
					            ...
					            widths="1800|6000|4000|0|0|0|0|0|0"  
