...
<body>
    <!----------------------------------------------------->
    <gw:data id="data_fpab00610" onreceive=""> 
        <xml> 
           <dso id="1" type="grid" function="st_lg_sel_fpab00610" > 
                  <input bind="idGrid" > 
                    <input bind="txtID" /> 
                    <input bind="txtName" /> 
                    </input> 
    ...
    <table style="height: 100%; width: 100%">
        ...
        <tr style="height: 99%">
            <td colspan="8">
                <gw:grid id="idGrid" header="_PK|Division ID|Division NM"
