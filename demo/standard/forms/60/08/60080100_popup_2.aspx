...
<gw:data id="datEmployeePopup"> 
    <xml> 
        <dso  type="grid" function="ac_sel_60080100_popup_2"> 
            <input> 
                <input bind="lstDept" /> 
                <input bind="chkTemp" /> 
                <input bind="txtTemp" /> 
				        ...
				        <table   border="0" CELLSPACING="0" CELLPADDING="0" style="height:inherit" >
					        ...
					        <tr>   
						        ...
						        <td width="40%" colspan=4><gw:list id="lstDept" styles="color:black;width:100%" value="ALL" onchange="OnChangeDept()"> 
	                                           <data><%=CtlLib.SetListDataSQL("SELECT PK,org_NM FROM TCO_org WHERE DEL_IF = 0 order by org_ID, org_NM")%>|ALL|Select All</data>
	                                           </gw:list > 
						        </td>
					        </tr>
				        </table>
