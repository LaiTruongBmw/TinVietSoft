...
public partial class rpt_hrem01500_0 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string p_tco_org_pk,p_emp_search,p_probation_type,p_contract_type,p_nation,p_from_date,p_to_date,p_status,p_lang;
     
		p_tco_org_pk 		 = Request["p_org_pk"].ToString();
		...
		if(p_lang == "ENG")
		{
			TemplateFile = "rpt_hrem01500_0_eng.xls";
		}
        else
			TemplateFile = "rpt_hrem01500_0_vie.xls";
		
        string TempFile = "../../../../system/temp/rpt_hrem01500_0_" + Session["User_ID"].ToString() + ".xls";
        ...
        string para = "'" + p_lang +"','" + p_emp_search + "','" + p_from_date + "','"+ p_to_date  + "','" + p_tco_org_pk + "','" + p_contract_type + "','"+ p_status + "','"+ p_nation +"'";
		
		DataTable dt_emp = CtlLib.TableReadOpenCursor("ST_HR_RPT_HREM01500_0", para);
