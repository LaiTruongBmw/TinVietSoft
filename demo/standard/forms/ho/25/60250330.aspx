	...
	{	
		 if(grdIssueInvoice.rows > 1)
		 {
			if(grdIssueInvoice.row >0)
			{
				...
				var url =System.RootURL + '/reports/gf/hg/60080010_envn.aspx?seq='+grdIssueInvoice.GetGridData(grdIssueInvoice.row,G_acc_slip_pk);
...
<body>
    ...
    <xml> 
        <dso  type="grid" parameter="0,10" function="ht_sel_60250330" procedure="ht_upd_60250330">
...
<gw:data id="dso_process_inv" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso  type="process" procedure="ht_pro_60250330" > 
            <input>
				<input bind="lstLocation" />
				<input bind="txtPK" />
                <input bind="dtFromDate" />
...
<gw:data id="dso_cancel_inv" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso  type="process" procedure="ht_pro_60250330_cancel" > 
            <input>
