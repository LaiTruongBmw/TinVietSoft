...
<%    
    ...
    dt1 = CtlLib.TableReadOpenCursor("SALE.sp_rpt_dsbs00240", "'" + p_partner_pk + "'");
    dt2 = CtlLib.TableReadOpenCursor("SALE.sp_rpt_dsbs00240_1", para);
%>
<head>
    ...
    <x:CF>Bitmap</x:CF>
        ...
        <tr height="32" style='mso-height-source: userset; height: 24.0pt'>
            ...
            <td class="xl49" width="62" style='border-top: none; border-left: none; width: 47pt'
                x:num>
                <span style='mso-spacerun: yes'></span><span style='mso-spacerun: yes'> <%= subqty %> </span>
            </td>
		...
		<tr height="34" style='mso-height-source: userset; height: 25.5pt'>
            <td colspan="7" height="34" class="xl58" width="846" style='border-right: .5pt solid black;
                height: 25.5pt; width: 635pt'>VAT(10%)</font>
            </td>
            ...
            <td class="xl49" width="101" style='border-top: none; border-left: none; width: 76pt'
                x:num>
                <span style='mso-spacerun: yes'></span><%= tax_amt %>
            </td>
            <td class="xl41" style='border-top: none; border-left: none'>
                &nbsp;
            </td>
        ...
        <tr height="17" style='height: 12.75pt'>
            ...
            <td class="xl50" colspan="2" style='mso-ignore: colspan'><%= dt1.Rows[0]["partner_name"] %>
            </td>
