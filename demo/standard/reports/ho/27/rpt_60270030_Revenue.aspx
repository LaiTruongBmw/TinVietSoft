...
<%
    ...
    DataTable dtMaster;
    dtMaster = CtlLib.TableReadOpenCursor("rpt_60270030_Revenue",l_parameter);
	...
	double l_guest = 0, l_food = 0, l_beverage = 0, l_other = 0, l_svc = 0, l_vat = 0, l_discount = 0, l_total = 0, l_adj = 0, l_cash = 0, l_credit = 0, l_fo = 0, l_debit = 0, l_office = 0, l_enter = 0, l_tran = 0, l_ftotal = 0;
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1792 style='border-collapse:
 ...
 <tr class=xl28 height=28 style='mso-height-source:userset;height:21.0pt'>
  ...
  <td class=xl38>Room No</td>
 </tr>
 <%for (int x = 0; x < dtMaster.Rows.Count; x++){
	l_guest 	+= double.Parse(dtMaster.Rows[x][3].ToString());
	l_food  	+= double.Parse(dtMaster.Rows[x][4].ToString());
	l_beverage	+= double.Parse(dtMaster.Rows[x][5].ToString());
	l_other		+= double.Parse(dtMaster.Rows[x][6].ToString());
	l_svc		+= double.Parse(dtMaster.Rows[x][7].ToString());
	l_vat		+= double.Parse(dtMaster.Rows[x][8].ToString());
	l_discount	+= double.Parse(dtMaster.Rows[x][9].ToString());
	l_total		+= double.Parse(dtMaster.Rows[x][10].ToString());
	l_adj		+= double.Parse(dtMaster.Rows[x][11].ToString());
	l_cash		+= double.Parse(dtMaster.Rows[x][14].ToString());
	l_credit	+= double.Parse(dtMaster.Rows[x][15].ToString());
	l_fo		+= double.Parse(dtMaster.Rows[x][16].ToString());
	l_debit		+= double.Parse(dtMaster.Rows[x][18].ToString());
	l_office	+= double.Parse(dtMaster.Rows[x][19].ToString());
	l_enter		+= double.Parse(dtMaster.Rows[x][20].ToString());
	l_tran		+= double.Parse(dtMaster.Rows[x][21].ToString());
	l_ftotal	+= double.Parse(dtMaster.Rows[x][22].ToString());
 %>
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl39><%=dtMaster.Rows[x][25]%></td>
 </tr>
 <%}%>
