...
public partial class rpt_60250150_collector_by_cash : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_60250150_collector_by_cash.xls";
        string TempFile = "../../../../system/temp/rpt_60250150_collector_by_cash_" + Session["User_ID"].ToString() + ".xls";
        ...
        para = "'" + l_dt_from + "','" + l_dt_to + "','" + l_invoice + "','" + l_crt_by + "'";
        dt = CtlLib.TableReadOpenCursor("ht_rpt_60250150_by_cash", para);
        //-----header---   
        ...
        for (int l_row = 1; l_row <= dt.Rows.Count; l_row++)
        {
            ...
            {
                if (col == 0 || col == 1 || col == 2 || col == 3 || col == 4|| col == 5|| col == 6|| col == 13|| col == 14 )
                {
