...
<%
    string dis_pk;
	dis_pk		 = Request["dis_pk"].ToString();
    string SQL
    = "Select A.Decide_no As Num     " + 
        ",B.Full_name As Full_name     " +
        ",(Case When Length(B.Birth_dt)=8 Then  Substr(B.Birth_dt,7,2)  End ) As Birthdate    " +
        ",(Case When Length(B.Birth_dt)=8 Then Substr(B.Birth_dt,5,2)  End ) As Birthmonth    " +
        ",Substr(B.Birth_dt,1,4) As Birthyear    " +
        ",(Select Code_nm From Vhr_hr_code Where Id='HR0021' And Code=B.Place_birth ) As Place_birth   " +
        ",B.Permanent_addr As Permanent_add    " +
        ",Substr(A.Start_dt,1,4) As Fromyear  " +
        ",Substr(A.Start_dt,5,2) As Frommonth  " +
        ",Substr(A.Start_dt,7.2) As Fromdate  " +
        ",Substr(A.End_dt,1,4) As Toyear  " +
        ",Substr(A.End_dt,5,2) As Tomonth  " +
        ",Substr(A.End_dt,7,2) As Todate  " +
        ",(Select Upper(Code_fnm) From Vhr_hr_code Where Id = 'HR0222' And Code = A.Kind ) Kind     " +
        ",(select code_fnm From vhr_hr_code where id = 'HR0149' and code = A.TREAT_DISC ) Treat_kind " +
        ",(Select Code_fnm From Vhr_hr_code Where Id='HR0008' And Code=B.Pos_type) As Position        " +
        ",(Select Co.Partner_lname From Tco_company Co Where Co.Del_if=0 And Co.Pk=B.Tco_company_pk) Co_lname     " +
        ",c.org_lnm " +
        "From Thr_discipline A,Thr_employee B,Tco_org C,Thr_work_group D     " +
...
<link rel=File-List href="rpt_hr_hrem00700_0_files/filelist.xml">
...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:Created>2018-04-04T09:08:00Z</o:Created>
  <o:LastSaved>2018-04-04T09:08:00Z</o:LastSaved>
  <o:Pages>1</o:Pages>
  <o:Words>153</o:Words>
...
<link rel=themeData href="rpt_hr_hrem00700_0_files/themedata.thmx">
<link rel=colorSchemeMapping
href="rpt_hr_hrem00700_0_files/colorschememapping.xml">
<!--[if gte mso 9]><xml>
 <w:WordDocument>
...
mso-ansi-language:EN-US'><%= dt_total.Rows[i]["Co_lname"].ToString() %></span></b><span style='font-family:"Calibri",sans-serif;mso-bidi-font-family:
AngsanaUPC;mso-ansi-language:EN-US'><span style='mso-spacerun:yes'>    </span><span
...
style='mso-tab-count:1'> </span>C&#7897;ng Hòa Xã H&#7897;i Ch&#7911;
Ngh&#297;a Vi&#7879;t Nam<o:p></o:p></span></b></p>
...
"Times New Roman",serif;mso-ansi-language:EN-US'>S&#7889;: <%= dt_total.Rows[i]["Num"].ToString() %></span></b><b
...
style='font-size:13.0pt;font-family:"Times New Roman",serif'>QUY&#7870;T &#272;&#7882;NH
<%= dt_total.Rows[i]["Kind"].ToString() %><o:p></o:p></span></b></p>
...
NL'> <%= dt_total.Rows[i]["Kind"].ToString() %><o:p></o:p></span></p>
...
lang=NL style='font-size:13.0pt;font-family:"Times New Roman",serif;mso-ansi-language:
NL'>Sinh ngày<span style='mso-tab-count:2'>           </span>: <%= dt_total.Rows[i]["Birthdate"].ToString() %>/<%= dt_total.Rows[i]["Birthmonth"].ToString() %>/<%= dt_total.Rows[i]["Birthyear"].ToString() %><span
...
margin-left:0cm;text-align:justify;line-height:normal;tab-stops:92.15pt'><span
lang=NL style='font-size:13.0pt;font-family:"Times New Roman",serif;mso-ansi-language:
NL'>Phòng Ban<span style='mso-tab-count:1'>          </span>: <%= dt_total.Rows[i]["org_lnm"].ToString() %><span
style='mso-tab-count:2'>                </span><o:p></o:p></span></p>

<p class=MsoNormal style='margin-top:3.0pt;margin-right:0cm;margin-bottom:3.0pt;
margin-left:0cm;text-align:justify;line-height:normal;tab-stops:92.15pt'><span
lang=NL style='font-size:13.0pt;font-family:"Times New Roman",serif;mso-ansi-language:
NL'>Ch&#7913;c v&#7909;<span style='mso-tab-count:1'>             </span>: <%= dt_total.Rows[i]["Position"].ToString() %><span style='mso-tab-count:6'>                                                            </span><o:p></o:p></span></p>

<p class=MsoNormal style='margin-top:3.0pt;margin-right:0cm;margin-bottom:3.0pt;
margin-left:0cm;text-align:justify;line-height:normal;tab-stops:92.15pt'><span
lang=NL style='font-size:13.0pt;font-family:"Times New Roman",serif;mso-ansi-language:
NL'>Hình th&#7913;c x&#7917; lý<span style='mso-tab-count:1'>   </span>: <%= dt_total.Rows[i]["Treat_kind"].ToString() %><span style='mso-tab-count:2'>                   </span><o:p></o:p></span></p>
...
style='mso-spacerun:yes'>  </span>t&#7915; ngày <%= dt_total.Rows[i]["Fromdate"].ToString() %> tháng <%= dt_total.Rows[i]["Frommonth"].ToString() %> n&#259;m <%= dt_total.Rows[i]["Fromyear"].ToString() %> ph&#7893;
bi&#7871;n &#273;&#7871;n ngày <%= dt_total.Rows[i]["Todate"].ToString() %> tháng <%= dt_total.Rows[i]["Tomonth"].ToString() %> n&#259;m <%= dt_total.Rows[i]["Toyear"].ToString() %>.<span
...
107%;font-family:"Times New Roman",serif'>GIÁM &#272;&#7888;C<o:p></o:p></span></b></p>

<p class=MsoNormal style='margin-left:324.0pt'><b style='mso-bidi-font-weight:
normal'><span style='font-size:13.0pt;line-height:107%;font-family:"Times New Roman",serif'><span
style='mso-spacerun:yes'>      </span><o:p></o:p></span></b></p>

<p class=MsoNormal style='margin-left:324.0pt'><b style='mso-bidi-font-weight:
normal'><span style='font-size:13.0pt;line-height:107%;font-family:"Times New Roman",serif'><o:p>&nbsp;</o:p></span></b></p>
...
<p class=MsoNormal style='margin-left:324.0pt'><b style='mso-bidi-font-weight:
normal'><span style='font-size:13.0pt;line-height:107%;font-family:"Times New Roman",serif'><span
style='mso-spacerun:yes'>       </span>Nguy&#7877;n V&#361; Phong<o:p></o:p></span></b></p>
<%
