...
<gw:data id="datGetContracList"> 
    <xml> 
        <dso  type="grid" function="ac_sel_60060010_contract_imex"> 
	    ...
	    <td width="100%">
	     <fieldset style="width: 100%; height: 100%; padding: 2">
	        <table border="0" width="100%" cellpadding="0" cellspacing="2"  id="table1">
              ...
              <td width="15%"><gw:textbox id="txtContractNo"  onenterkey="OnSearch()"  /></td>
              <td width="10%" align=Right><a href="#" onclick="OnGetPartner()">Partner</a></td>
