...
<%
    string p_contract_pk;
    p_contract_pk       = Request["p_contract_pk"].ToString();
    string SQL
	= "select a.CONTRACT_NO as num0 " +
        ...
        ",(select CODE_NM from vhr_hr_code where id='HR0021' and code=b.PLACE_BIRTH ) as place_birth9 " +
        ...
        ",to_char(a.pro_sal,'99,999,999') as salary32 " +
...
<span class=SpellE><span class=GramE><%= dt_total.Rows[i]["CO_LNAME"].ToString() %> </span></span> </b><span
...
bên là Ông/Bà: <%= dt_name.Rows[1][1].ToString() %></span><span style='font-size:15.0pt;mso-bidi-font-size:
...
<span class=spelle>Ông/Bà</span>: </span><span style='font-size:11.0pt'><%= dt_total.Rows[i][4].ToString() %> </span><span
...
line-height:15.0pt;mso-line-height-rule:exactly;mso-list:none;tab-stops:.5in'><i
style='mso-bidi-font-style:normal'><span style='font-size:13.0pt;mso-bidi-font-size:
11.0pt;font-family:"Times New Roman"'><o:p>&nbsp;</o:p></span></i></p>
...
style='font-size:13.0pt'><span style='mso-spacerun:yes'>          </span><o:p></o:p></span></b></p>
...
mso-line-height-rule:exactly;mso-list:none;tab-stops:.5in'><b style='mso-bidi-font-weight:
normal'><i style='mso-bidi-font-style:normal'><span style='font-size:10.0pt;
mso-bidi-font-size:9.0pt;font-family:"Times New Roman"'><o:p>&nbsp;</o:p></span></i></b></p>
...
xã hội và bảo hiểm y tế: <%= dt_name.Rows[18][1].ToString() %><o:p></o:p></span></p>
...
style='mso-bidi-font-style:normal'><span style='font-size:11.0pt;mso-bidi-font-size:
8.0pt'>Social insurance and health insurance<o:p></o:p></span></i></p>
