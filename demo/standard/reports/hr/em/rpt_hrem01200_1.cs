...
public partial class rpt_hrem01200_1 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {

        CtlLib.SetUser(Session["APP_DBUSER"].ToString());
		string p_sal,p_org,p_status,p_search,p_from_dt,p_to_dt,p_change,p_lang;
			
			p_sal = Request["l_sal"].ToString();
			p_org = Request["l_org"].ToString();
			p_status = Request["l_emp_status"].ToString();
			p_search = Request["l_search_temp"].ToString();
			p_from_dt = Request["l_from_app"].ToString();
			p_to_dt = Request["l_to_app"].ToString();
			p_change = Request["l_change"].ToString();
			p_lang = Request["l_lang"].ToString();
			
        string TemplateFile;
		if(p_lang == "ENG")
		{
			TemplateFile = "rpt_hrem01200_1_eng.xls";
		}
        else
			TemplateFile = "rpt_hrem01200_1_vie.xls";
		
        string TempFile = "../../../../system/temp/rpt_hrem01200_1" + Session["User_ID"].ToString() + ".xls";
        ...
        string para = "'" + p_org + "','" + p_status + "','" + p_search + "','" + p_from_dt 
					  + "','" + p_to_dt + "','" + p_change + "','" + p_lang + "'";
		
		DataTable dt_emp = CtlLib.TableReadOpenCursor("ST_HR_RPT_HREM01200_1", para);
