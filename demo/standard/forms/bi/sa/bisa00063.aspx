...
{  
 ...
 {  
     ...
     data = "<%=CtlLib.SetListDataSQL("select pk, grp_cd || ' - ' || grp_nm from comm.tco_itemgrp where del_if = 0 and use_yn='Y' and leaf_yn = 'N'  order by grp_nm ") %>||Select All";     
...
function OnDataReceive(obj)
{
    switch(obj.id)
    {
        ...
        case "pro_bisa00063": 
            ...
            {        
                 var url =System.RootURL + '/reports/bi/sa/rpt_bisa00060.aspx?p_pk='+txtMasterPK.text+'&p_user='+txtUser.text;
            }
            else
            {
                 var url =System.RootURL + '/reports/bi/sa/rpt_bisa00061.aspx?p_pk='+txtMasterPK.text+'&p_user='+txtUser.text;
            }
            window.open(url);    
        break;
...
<body>
    ...
    <!------------------------------------------------------------------>
    <gw:data id="data_bisa00063" onreceive="OnDataReceive(this)"> 
        <xml>                                   
            <dso id="3" type="grid"  function="inv.sp_sel_bisa00063" > 
        ...
        <!---------------------------------------------------------------->
    <gw:data id="pro_bisa00063" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="process" procedure="inv.sp_pro_bisa00063" >
                <input>
                ...
                <table style="width: 100%; height: 100%">                   
                    <tr style="height: 1%">
                        ...
                        <td style="width: 35%" >
                         ...
                         <td style="width: 1%">
                            <gw:button img="search" alt="Search" id="btnSearch2" onclick="OnSearch()" />
                        </td>
                        <td style="width:1%">
                            <gw:button id="ibtnReport" img="excel" alt="Report" text="Report" onclick="OnPrintReport()" />
                        </td>
                    </tr>
                    <tr style="height: 98%">
