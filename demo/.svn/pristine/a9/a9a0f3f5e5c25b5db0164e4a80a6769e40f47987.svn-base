...
function OnReport()
 {
	 ...
	 {
		 var url = '/standard/reports/60/28/rpt_60280130_service_use.aspx?p_dtfrom='+dtFromDate.value+ "&p_dtto="+dtToDate.value+ "&p_service_name="+txt_ServicesName.text;
...
<body>
    ...
    <xml> 
        <dso  type="grid"  function="st_ht_sel_60280130" procedure=""> 
