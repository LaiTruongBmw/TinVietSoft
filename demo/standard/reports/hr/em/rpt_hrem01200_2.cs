...
public partial class rpt_hrem01200_2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		if(p_lang == "ENG")
		{
			TemplateFile = "rpt_hrem01200_2_eng.xls";
		}
        else
			TemplateFile = "rpt_hrem01200_2_vie.xls";
		
        string TempFile = "../../../../system/temp/rpt_hrem01200_2" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dt_emp = CtlLib.TableReadOpenCursor("ST_HR_RPT_HREM01200_2", para);
