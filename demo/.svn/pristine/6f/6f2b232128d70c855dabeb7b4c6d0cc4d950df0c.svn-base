...
function onReport()
{
	...
	{
		var url = System.RootURL + '/standard/reports/60/26/rpt_602660_vie.aspx?p_year='+dtYear.value+'&p_tco_company_pk='+lstCompany.value+'&p_scale='+txtScale.text+'&p_ccy='+lstCurrent.value+'&p_exrate='+txtrate1.text+'&p_status='+rbstatus.value+'&p_language='+lstLang.value;
		System.OpenTargetPage(url); 
	}
	else
	{
		var url = System.RootURL + '/standard/reports/60/26/rpt_602660_eng_vie_kor.aspx?p_year='+dtYear.value+'&p_tco_company_pk='+lstCompany.value+'&p_scale='+txtScale.text+'&p_ccy='+lstCurrent.value+'&p_exrate='+txtrate1.text+'&p_status='+rbstatus.value+'&p_language='+lstLang.value;
		System.OpenTargetPage(url); 
	}
}
