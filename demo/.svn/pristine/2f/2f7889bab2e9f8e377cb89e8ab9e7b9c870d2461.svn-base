...
public partial class rpt_60300010_daily_bking_source_static : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_60300010_daily_bking_source_static.xls";
        string TempFile = "../../../../system/temp/rpt_60300010_daily_bking_source_static_" + Session["User_ID"].ToString() + ".xls";
        ...
        dt = CtlLib.TableReadOpenCursor("rpt_60300010_source_statistic", para);
        //-----header---   
