...
function AccountRowClick()
{
    ...
    if( event.col == 3 || event.col == 4 || event.col == 5)
	{
	    ...
	    //var fpath   = System.RootURL + "/standard/forms/ff/co/ffco002001.aspx?comm_code="+sNm+"&val1="+txtInput_PK.GetData()+"&dsqlid=ac_sel_60130110_account_popup";
        var fpath   = System.RootURL + "/standard/forms/gf/co/ffco002001.aspx?comm_code=" + sNm + "&val1=" + txtGrpCode_pk.GetData() + "&val3=" + lstCompany.GetData() + "&dsqlid=ac_sel_60130110_account_popup";	    
