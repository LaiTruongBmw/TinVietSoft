...
function BindingDataList()
{
   ...
   var ls_data8    = "<%=CtlLib.SetListDataSQL("SELECT b.CODE, b.CODE_NM FROM TAC_COMMCODE_MASTER A, TAC_COMMCODE_DETAIL B WHERE A.PK = B.TAC_COMMCODE_MASTER_PK AND A.ID = 'GFQC0016' AND A.DEL_IF = 0 AND B.DEL_IF = 0 and b.code not in ('1280_v2','1300_v2','1320_v2','1310_v2') and b.use_YN = 'Y' order by b.CODE_NM")%>";
   ...
   lstReportLocation.value = '640_v2';
    if (ls_data7 == 'T')
    {
        txtvoucher_auto.SetEnable(false);
        txtvoucher_auto.SetDataText('');
...
function Popup_OnSelect_Acc(p_payrec, p_drcr)
{
    ...
    var fpath   = System.RootURL + "/standard/forms/60/05/60050010_popup_new.aspx?comm_nm="+ '' + "&comm_code=" + '' + "&comm_nm2=" + txttransaction_code.GetData() + '' + "&val1=" + "&val2=" + p_drcr + "&val3=" + lstCompany.GetData() + "&dsqlid=AC_SEL_ACC_DRCR_PAYREC";    
    aValue      = System.OpenModal(  fpath , 550 , 550 , 'resizable:yes;status:yes');	
    if (aValue != null)
    {
        if (aValue.length > 0)
            ...
            for(i=0; i<aValue.length; i++)
            {
                ...
                if (tmp[1] != 0)
                {
                    ...
                    if ((p_drcr == 'D') && (txtStatus.GetData() == 1 || txtStatus.GetData() == ''))  
                    {
						...
						grdDebit.SetGridText( grdDebit.row, 6, tmp[6]);  
                        grdDebit.SetGridText( grdDebit.row, 7, book_rate);
					    click_dr = 0;
                        click_cr = 0;
					    RowClick_DR();
                    }
                    else if ((p_drcr == 'C') && (txtStatus.GetData() == 1 || txtStatus.GetData() == ''))
                    {
						...
						grdCredit.SetGridText( grdCredit.row, 6, tmp[6]); 
                        grdCredit.SetGridText( grdCredit.row, 7, book_rate);       //Rate
					    var ls_ref;
					    if (grdDebit.row != -1)
					    {
					        ls_ref = grdDebit.GetGridData(grdDebit.row, 3);
		...
		{ 
	            ...
	            case "380":
				  ...
				  case "640_v2":
					...
					{
						var url =System.RootURL + '/standard/reports/gf/br/gfbr00030_PaymentVoucher_General_Bank_pdf_A5.aspx'+rqt; 
					}
				  break;
				  case "650_v2":
	              ...
	              break;
				  case "970_v2":
	                        var url = System.RootURL + '/standard/reports/gf/br/gfbr00030_UNC_OceanBank_GRT_pdf.aspx?p_Seq='+ txtseq.text; 
	              break; 	
	              ...
	              break;  
				  case "1060_v2":
	                        var url = System.RootURL + '/standard/reports/gf/br/gfbr00040_KIB_GiayChuyenTien_2.aspx?Seq='+ txtseq.text; 
	              break;  
				  case "1070_v2":
	                        var url = System.RootURL + '/standard/reports/gf/br/gfbr00040_ShinhanBank_DRVV.aspx?p_Seq='+ txtseq.text; 
	              break; 
				  case '1080_v2':
							var url = System.RootURL + '/standard/reports/gf/br/gfbr00040_Techcombank_UNC_pdf.aspx?p_Seq='+ txtseq.text; 
				  break;
				  case '1090_v2':
							var url = System.RootURL + '/standard/reports/gf/br/gfbr00040_ABBank_Payment_Order_pdf.aspx?p_Seq='+ txtseq.text; 
				  break;
				  case '1100_v2':
							var url = System.RootURL + '/standard/reports/gf/br/gfbr00040_ACB_Payment_Order_pdf.aspx?p_Seq='+ txtseq.text; 
				  break;
				  case '1110_v2':
							var url = System.RootURL + '/standard/reports/gf/br/gfbr00040_Kookminbank_Payment_Order_pdf.aspx?p_Seq='+ txtseq.text; 
				  break;
				  case "1120_v2":
	                        var url = System.RootURL + '/standard/reports/gf/br/gfbr00030_UNC_OceanBank_PaymentOrder_pdf.aspx?p_Seq='+ txtseq.text; 
	              break; 
				  case "1130_v2":
	                        var url = System.RootURL + '/standard/reports/gf/br/gfbr00030_UNC_BIDV_PaymentOrder_pdf.aspx?p_Seq='+ txtseq.text; 
	              break; 
				  case "1150_v2":
				  ...
				  case "1160_v2":
	                        var url = System.RootURL + '/standard/reports/gf/br/gfbr00040_HD_bank_UNC_EXCEL.aspx?p_Seq='+ txtseq.text; 
	              break; 

				  case "1210_v2":
	                        var url = System.RootURL + '/standard/reports/gf/br/gfbr00040_HSBC_bank_UNC_EXCEL.aspx?p_Seq='+ txtseq.text; 
	              break; 
				  case "1220_v2":
	                        var url = System.RootURL + '/standard/reports/gf/br/gfbr00040_Seabank_Payment_Order_EXCEL.aspx?p_Seq='+ txtseq.text; 
	              break; 
				  case "1230_v2":
	                        var url = System.RootURL + '/standard/reports/gf/br/gfbr00040_ANZ_Payment_Order_EXCEL.aspx?p_Seq='+ txtseq.text; 
	              break;
				  case "1240_v2":
	                        var url = System.RootURL + '/standard/reports/gf/br/gfbr00040_ShinhanBank_Payment_Order_latest.aspx?p_Seq='+ txtseq.text; 
	              break; 
				  case "1250_v2":
	                        var url = System.RootURL + '/standard/reports/gf/br/rpt_gfbr00040_HSBC_CashWithDrawal_latest.aspx?p_Seq='+ txtseq.text; 
	              break; 
				  case "1270_v2":
	                        var url = System.RootURL + '/standard/reports/gf/br/rpt_gfbr00040_Vietinbank.aspx?p_Seq='+ txtseq.text; 
	              break; 
		        }
			System.OpenTargetPage( url , 'newform' );
		}
...
function onViewTAccount()
{
    if (txtseq.text !='')
    {
		...
		var fpath   = System.RootURL + '/standard/forms/gf/br/gfbr00030_popup.aspx?PK_ROW=' + pk + '&APPRCANCEL=' + status;
		var wWidth  = 950;
		var wHeight = 565;
...
function onEmpPopUp()
{
	...
	var path = System.RootURL + '/standard/forms/gf/os/gfos00070_popup_2.aspx';
...
<gw:data id="dso_process_exrate" onreceive="OnDataReceive(this)">
        <xml> 
            <dso type="process" procedure="ac_pro_60050040_exrate">
                <input>
                     <input bind="lstCompany"/>
                     <input bind="dtDate"/>
                     <input bind="txtseq1"/>
            ...
            <td colspan='2'>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
									...
									<td width='100%' colspan='6' align='right'>
										<table width='100%' cellpadding='1' cellspacing='1'>
												<tr>
														...
														<td width=""><gw:button id="btnReportRV" img="excel" text="Print"alt="Print RV" onclick="OnReportRV()" /></td>
                                        ...
                                        <td >
                                                <table width='100%' cellpadding='1' cellspacing='1'>
                                                        <tr>
                                                                ...
                                                                <td width="100%"><gw:textbox id="txtpay_person" /></td>
                                                                <td width="" align="right" style='white-space:nowrap'>Ex.Rate (BK)</td>
                                                                <td width="" style='white-space:nowrap'><gw:label id="lblBookRate" type="number" format="#,###,###,###,###.##R"/></td>
																<td width=""><gw:button id="btnExRate" img="Ex.Rate" text="Ex.Rate" onclick="OnExRate()" /></td>
                                                        </tr>
                                                </table>
                                        </td>
                                </tr>
                                ...
                                <tr>
									...
									<td width="" colspan=''><gw:list id="lstReportLocation" styles="width:100%"/></td>
