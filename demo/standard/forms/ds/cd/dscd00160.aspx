                    ...
                    <td colspan="3">
                        <table style="width: 100%; height: 100%">
                            <tr>
                                ...
                                <td style="width: 1%">
                                    <gw:button id="idBtnReturn" img="Return" text="Return" onclick="OnProcess('Return')" />
                                </td>
                                <td style="width: 1%">
                                    <gw:button id="idBtnTransfer" img="Trans" text="Trans" onclick="OnProcess('Trans')" />
                                </td>
								<td style="width: 1%">
                                    <gw:button id="idBtnIncome" img="Income" text="Income" onclick="OnProcess('Income')" />
                                </td>
                                <td style="width: 96%">
                                </td>
                            </tr>
                                    ...
                                    <td align="left">
                                        <table style="width: 100%; height: 100%">
                                            <tr>
									            ...
									            <td style="width: 5%">
                                                    <gw:button img="process" alt="Grouping Item" id="btnGroupItem" onclick="OnProcess('Grouping')" />
                                                </td>
                                    ...
                                    <td align="right">
                                        <table style="width: 100%; height: 100%">
                                            <tr>
                                                ...
                                                <td align="right" style="width: 1%">
                                                    <gw:button id="idBtnREQ" img="REQ" text="REQ" onclick="OnAddNew('REQ')" />
                                                </td>
									            <td align="right" style="width: 1%">
                                                    <gw:button id="idBtnSCAN" img="SCAN" text="SCAN" onclick="OnAddNew('SCAN')" />
                                                </td>
                                                <td align="right" style="width: 1%">
                                                    <gw:button id="idBtnReSULT" img="RESULT" text="RESULT" onclick="OnAddNew('RESULT')" />
                                                </td>
                                                <td align="right" style="width: 1%">
                                                    <gw:button id="idBtnSaleOrder" img="S/ORDER" text="S/ORDER" onclick="OnAddNew('SALEORDER')" />
                                                </td>
                                                <td align="right" style="width: 1%">
