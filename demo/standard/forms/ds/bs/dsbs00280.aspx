...
<body>
    ...
    <gw:data id="data_dsbs00280" onreceive="OnDataReceive(this)"> 
	    <xml> 
		    <dso type="grid" function="st_lg_sel_dsbs00280" parameter="0,1,2,3,4,5" procedure="st_lg_upd_dsbs00280"   > 
			    <input  > 
    ...
    <gw:data id="pro_dsbs00280" onreceive="OnDataReceive(this)"> 
        <xml>                                                               
             <dso id="1" type="process"  procedure="st_lg_pro_dsbs00280"> 
                <input> 
			        <input bind="lstTranStyle" />
			        <input bind="dtFrom" />
			        <input bind="dtTo" />  		
    ...
    <table style="width: 100%; height: 100%" name="Transaction Code">
        <tr style="height: 1%">
            ...
            <td style="width: 1%">
                <gw:button id="btnUnDelete" img="udelete" onclick="OnUnDelete(grdDetail)" />
            </td>
            <td style="width: 1%">
