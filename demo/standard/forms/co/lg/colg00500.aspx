...
<body>
    <!---------------------------------------------------------------->
    <gw:data id="data_colg00500" onreceive="OnReceiveData(this)"> 
        <xml>                                                               
            <dso id="1" type="control" user="prod" function="st_lg_sel_colg00500_0"  > 
                <inout> 
    ...
    <!---------------------------------------------------------------->
    <gw:data id="data_colg00500_1" onreceive="OnReceiveData(this)"> 
    <xml> 
           <dso id="1" type="grid" function="st_lg_sel_colg00500_1" > 
                  <input bind="idGrid" >
				  	<input bind="lstLang" /> 
                    <input bind="lstGroup" />
                    <input bind="txtItem" />
