...
public partial class rpt_bisc00020_KB01 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_bisc00020_KB01.xls";
        string TempFile = "../../../../system/temp/rpt_bisc00020_KB01_" + Session["User_ID"].ToString() + ".xls";
        ...
        DataTable dtInfo   = CtlLib.TableReadOpenCursor("st_lg_rpt_bisc00020_KB01_1", "'" + Session["User_ID"].ToString() + "'");
	 	 
		string para = "'" + p_wh_pk + "','" + p_from_date + "','" + p_to_date + "'";	
		
        DataTable dtMaster = CtlLib.TableReadOpenCursor("st_lg_rpt_bisc00020_KB01_2", para);
		
		para = "'" + p_from_date + "','" + p_to_date + "','" + p_wh_pk + "','" + p_item_group_pk + "','" + p_item + "'";	
		
        DataTable dtDetail = CtlLib.TableReadOpenCursor("st_lg_rpt_bisc00020_KB01_3", para);
        ...
        {            		
			...
			exSheet.Cells[l_pos + i, 5].Value = dtDetail.Rows[i]["tr_date"].ToString();
			
			exSheet.Cells[l_pos + i, 6].Value = dtDetail.Rows[i]["unit_price"];
