...
<%    
    ...
    DataTable dt, dt1;
    dt = CtlLib.TableReadOpenCursor("st_lg__rpt_dscd00030_5", "'" + p_from_date + "','" + p_to_date + "','" + Session["User_ID"].ToString() + "'");
    dt1 = CtlLib.TableReadOpenCursor("st_lg__rpt_dscd00030_6",para);
