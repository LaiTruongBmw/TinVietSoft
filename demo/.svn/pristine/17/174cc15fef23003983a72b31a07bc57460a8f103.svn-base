...
{		if(obj=='1')
		...
		if(obj=='2')
		{
			 if(grdLaundryReport.rows > 1)
			 {
				var url = '/standard/reports/ho/28/rpt_60280020_rvn_laundry_detail.aspx?p_dtfrom='+dtFromDate.GetData()+"&p_dtto="+dtToDate.GetData(); 
...
<body>
    ...
    <xml> 
        <dso  type="grid" function="ht_sel_60280020"> 
