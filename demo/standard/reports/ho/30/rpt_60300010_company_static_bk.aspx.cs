...
public partial class rpt_60300010_company_static_bk : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
     ...
     CtlLib.SetUser(Session["APP_DBUSER"].ToString());
        ...
        string TemplateFile = "rpt_60300010_company_static_bk.xls";
        string TempFile = "../../../../system/temp/rpt_60300010_company_static_bk_" + Session["User_ID"].ToString() + ".xls";
